...
class Stack_Entry : public ::protozero::Message {
 public:
  ...
  // functions are).
  // TODO(altimin): Use inline variable instead after adopting C++17.
  static constexpr FieldMetadata_CallsiteId kCallsiteId() { return {}; }
  ...
  // functions are).
  // TODO(altimin): Use inline variable instead after adopting C++17.
  static constexpr FieldMetadata_AnnotatedCallsiteId kAnnotatedCallsiteId() { return {}; }
  ...
  // functions are).
  // TODO(altimin): Use inline variable instead after adopting C++17.
  static constexpr FieldMetadata_FrameId kFrameId() { return {}; }
