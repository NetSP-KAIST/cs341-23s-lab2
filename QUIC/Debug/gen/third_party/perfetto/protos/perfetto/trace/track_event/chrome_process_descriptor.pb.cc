...
PROTOBUF_CONSTEXPR ChromeProcessDescriptor::ChromeProcessDescriptor(
  ...
  : host_app_package_name_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{})
  , process_type_(0)
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ChromeProcessDescriptorDefaultTypeInternal _ChromeProcessDescriptor_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> ChromeProcessDescriptor_ProcessType_strings[41] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry ChromeProcessDescriptor_ProcessType_entries[] = {
  ...
  { {ChromeProcessDescriptor_ProcessType_names + 404, 25}, 19 },
  { {ChromeProcessDescriptor_ProcessType_names + 429, 23}, 9 },
  { {ChromeProcessDescriptor_ProcessType_names + 452, 28}, 28 },
  { {ChromeProcessDescriptor_ProcessType_names + 480, 31}, 27 },
  { {ChromeProcessDescriptor_ProcessType_names + 511, 24}, 22 },
  { {ChromeProcessDescriptor_ProcessType_names + 535, 29}, 36 },
  { {ChromeProcessDescriptor_ProcessType_names + 564, 30}, 15 },
  { {ChromeProcessDescriptor_ProcessType_names + 594, 31}, 35 },
  { {ChromeProcessDescriptor_ProcessType_names + 625, 26}, 23 },
  { {ChromeProcessDescriptor_ProcessType_names + 651, 24}, 31 },
  { {ChromeProcessDescriptor_ProcessType_names + 675, 25}, 38 },
  { {ChromeProcessDescriptor_ProcessType_names + 700, 30}, 39 },
  { {ChromeProcessDescriptor_ProcessType_names + 730, 23}, 33 },
  { {ChromeProcessDescriptor_ProcessType_names + 753, 33}, 29 },
  { {ChromeProcessDescriptor_ProcessType_names + 786, 23}, 11 },
  { {ChromeProcessDescriptor_ProcessType_names + 809, 23}, 10 },
  { {ChromeProcessDescriptor_ProcessType_names + 832, 19}, 21 },
  { {ChromeProcessDescriptor_ProcessType_names + 851, 24}, 18 },
  { {ChromeProcessDescriptor_ProcessType_names + 875, 24}, 14 },
  { {ChromeProcessDescriptor_ProcessType_names + 899, 29}, 17 },
  { {ChromeProcessDescriptor_ProcessType_names + 928, 24}, 30 },
  { {ChromeProcessDescriptor_ProcessType_names + 952, 19}, 0 },
  { {ChromeProcessDescriptor_ProcessType_names + 971, 15}, 3 },
  { {ChromeProcessDescriptor_ProcessType_names + 986, 14}, 4 },
};

static const int ChromeProcessDescriptor_ProcessType_entries_by_number[] = {
  38, // 0 -> PROCESS_UNSPECIFIED
  0, // 1 -> PROCESS_BROWSER
  4, // 2 -> PROCESS_RENDERER
  39, // 3 -> PROCESS_UTILITY
  40, // 4 -> PROCESS_ZYGOTE
  6, // 5 -> PROCESS_SANDBOX_HELPER
  1, // 6 -> PROCESS_GPU
  3, // 7 -> PROCESS_PPAPI_PLUGIN
  2, // 8 -> PROCESS_PPAPI_BROKER
  18, // 9 -> PROCESS_SERVICE_NETWORK
  32, // 10 -> PROCESS_SERVICE_TRACING
  31, // 11 -> PROCESS_SERVICE_STORAGE
  7, // 12 -> PROCESS_SERVICE_AUDIO
  11, // 13 -> PROCESS_SERVICE_DATA_DECODER
  35, // 14 -> PROCESS_SERVICE_UTIL_WIN
  23, // 15 -> PROCESS_SERVICE_PROXY_RESOLVER
  8, // 16 -> PROCESS_SERVICE_CDM
  36, // 17 -> PROCESS_SERVICE_VIDEO_CAPTURE
  34, // 18 -> PROCESS_SERVICE_UNZIPPER
  17, // 19 -> PROCESS_SERVICE_MIRRORING
  12, // 20 -> PROCESS_SERVICE_FILEPATCHER
  33, // 21 -> PROCESS_SERVICE_TTS
  21, // 22 -> PROCESS_SERVICE_PRINTING
  25, // 23 -> PROCESS_SERVICE_QUARANTINE
  10, // 24 -> PROCESS_SERVICE_CROS_LOCALSEARCH
  9, // 25 -> PROCESS_SERVICE_CROS_ASSISTANT_AUDIO_DECODER
  13, // 26 -> PROCESS_SERVICE_FILEUTIL
  20, // 27 -> PROCESS_SERVICE_PRINTCOMPOSITOR
  19, // 28 -> PROCESS_SERVICE_PAINTPREVIEW
  30, // 29 -> PROCESS_SERVICE_SPEECHRECOGNITION
  37, // 30 -> PROCESS_SERVICE_XRDEVICE
  26, // 31 -> PROCESS_SERVICE_READICON
  15, // 32 -> PROCESS_SERVICE_LANGUAGEDETECTION
  29, // 33 -> PROCESS_SERVICE_SHARING
  16, // 34 -> PROCESS_SERVICE_MEDIAPARSER
  24, // 35 -> PROCESS_SERVICE_QRCODEGENERATOR
  22, // 36 -> PROCESS_SERVICE_PROFILEIMPORT
  14, // 37 -> PROCESS_SERVICE_IME
  27, // 38 -> PROCESS_SERVICE_RECORDING
  28, // 39 -> PROCESS_SERVICE_SHAPEDETECTION
...
const std::string& ChromeProcessDescriptor_ProcessType_Name(
  ...
  static const bool dummy =
      ::PROTOBUF_NAMESPACE_ID::internal::InitializeEnumStrings(
          ...
          41, ChromeProcessDescriptor_ProcessType_strings);
  (void) dummy;
...
bool ChromeProcessDescriptor_ProcessType_Parse(
  ...
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      ChromeProcessDescriptor_ProcessType_entries, 41, name, &int_value);
  if (success) {
...
ChromeProcessDescriptor::ChromeProcessDescriptor(const ChromeProcessDescriptor& from)
  ...
  host_app_package_name_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    host_app_package_name_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_host_app_package_name()) {
    host_app_package_name_.Set(from._internal_host_app_package_name(), 
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&process_type_) - reinterpret_cast<char*>(this)),
...
inline void ChromeProcessDescriptor::SharedDtor() {
  ...
  host_app_package_name_.Destroy();
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.ChromeProcessDescriptor)
  ...
  if (cached_has_bits & 0x00000001u) {
    host_app_package_name_.ClearNonDefaultToEmpty();
  }
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 40)) {
          ...
          crash_trace_id_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.ChromeProcessDescriptor)
  ...
  if (cached_has_bits & 0x0000001fu) {
    if (cached_has_bits & 0x00000001u) {
      _internal_set_host_app_package_name(from._internal_host_app_package_name());
    }
    if (cached_has_bits & 0x00000002u) {
...
void ChromeProcessDescriptor::InternalSwap(ChromeProcessDescriptor* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &host_app_package_name_, lhs_arena,
      &other->host_app_package_name_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(ChromeProcessDescriptor, legacy_sort_index_)
      + sizeof(ChromeProcessDescriptor::legacy_sort_index_)
      - PROTOBUF_FIELD_OFFSET(ChromeProcessDescriptor, process_type_)>(
          reinterpret_cast<char*>(&process_type_),
          reinterpret_cast<char*>(&other->process_type_));
}
