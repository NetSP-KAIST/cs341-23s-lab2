...
bool EntityStateResidency::operator==(const EntityStateResidency& other) const {
  return unknown_fields_ == other.unknown_fields_
   && power_entity_state_ == other.power_entity_state_
...
bool EntityStateResidency_StateResidency::operator==(const EntityStateResidency_StateResidency& other) const {
  return unknown_fields_ == other.unknown_fields_
   ...
   && total_time_in_state_ms_ == other.total_time_in_state_ms_
   && total_state_entry_count_ == other.total_state_entry_count_
   && last_entry_timestamp_ms_ == other.last_entry_timestamp_ms_;
}
