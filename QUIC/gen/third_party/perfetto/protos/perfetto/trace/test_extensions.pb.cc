...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TestExtensionDefaultTypeInternal _TestExtension_default_instance_;
PROTOBUF_CONSTEXPR TestExtensionChild::TestExtensionChild(
    ::_pbi::ConstantInitialized)
  : debug_annotations_()
  , child_field_for_testing_(&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}){}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TestExtensionChildDefaultTypeInternal _TestExtensionChild_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
TestExtensionChild::TestExtensionChild(const TestExtensionChild& from)
  ...
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
  child_field_for_testing_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    child_field_for_testing_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (from._internal_has_child_field_for_testing()) {
    child_field_for_testing_.Set(from._internal_child_field_for_testing(), 
...
inline void TestExtensionChild::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  child_field_for_testing_.Destroy();
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TestExtensionChild)
  ...
  if (cached_has_bits & 0x00000001u) {
    child_field_for_testing_.ClearNonDefaultToEmpty();
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:perfetto.protos.TestExtensionChild)
  ...
  if (from._internal_has_child_field_for_testing()) {
    _internal_set_child_field_for_testing(from._internal_child_field_for_testing());
  }
  _internal_metadata_.MergeFrom<std::string>(from._internal_metadata_);
}
...
void TestExtensionChild::InternalSwap(TestExtensionChild* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &child_field_for_testing_, lhs_arena,
      &other->child_field_for_testing_, rhs_arena
  );
}
