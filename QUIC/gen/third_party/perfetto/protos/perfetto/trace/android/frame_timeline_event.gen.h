...
class PERFETTO_EXPORT_COMPONENT FrameTimelineEvent : public ::protozero::CppMessageObj {
 public:
...
class PERFETTO_EXPORT_COMPONENT FrameTimelineEvent_FrameEnd : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
...
class PERFETTO_EXPORT_COMPONENT FrameTimelineEvent_ActualSurfaceFrameStart : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kCookieFieldNumber = 1,
    kTokenFieldNumber = 2,
  ...
  bool has_is_buffer() const { return _has_field_[11]; }
...
class PERFETTO_EXPORT_COMPONENT FrameTimelineEvent_ExpectedSurfaceFrameStart : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kCookieFieldNumber = 1,
    kTokenFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT FrameTimelineEvent_ActualDisplayFrameStart : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kCookieFieldNumber = 1,
    kTokenFieldNumber = 2,
...
class PERFETTO_EXPORT_COMPONENT FrameTimelineEvent_ExpectedDisplayFrameStart : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
    kCookieFieldNumber = 1,
    kTokenFieldNumber = 2,
