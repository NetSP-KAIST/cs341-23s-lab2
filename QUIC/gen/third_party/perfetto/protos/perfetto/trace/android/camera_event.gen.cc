...
bool AndroidCameraSessionStats_CameraGraph_CameraEdge::operator==(const AndroidCameraSessionStats_CameraGraph_CameraEdge& other) const {
  return unknown_fields_ == other.unknown_fields_
   && output_node_id_ == other.output_node_id_
   && output_id_ == other.output_id_
   && input_node_id_ == other.input_node_id_
   && input_id_ == other.input_id_
   && vendor_data_version_ == other.vendor_data_version_
   && vendor_data_ == other.vendor_data_;
}
...
bool AndroidCameraSessionStats_CameraGraph_CameraNode::operator==(const AndroidCameraSessionStats_CameraGraph_CameraNode& other) const {
  return unknown_fields_ == other.unknown_fields_
   ...
   && input_ids_ == other.input_ids_
   && output_ids_ == other.output_ids_
   && vendor_data_version_ == other.vendor_data_version_
   && vendor_data_ == other.vendor_data_;
}
...
bool AndroidCameraFrameEvent::operator==(const AndroidCameraFrameEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   ...
   && request_received_ns_ == other.request_received_ns_
   && request_processing_started_ns_ == other.request_processing_started_ns_
   && start_of_exposure_ns_ == other.start_of_exposure_ns_
   && start_of_frame_ns_ == other.start_of_frame_ns_
   && responses_all_sent_ns_ == other.responses_all_sent_ns_
   && capture_result_status_ == other.capture_result_status_
   && skipped_sensor_frames_ == other.skipped_sensor_frames_
   && capture_intent_ == other.capture_intent_
   && num_streams_ == other.num_streams_
   && node_processing_details_ == other.node_processing_details_
   && vendor_data_version_ == other.vendor_data_version_
   && vendor_data_ == other.vendor_data_;
}
...
bool AndroidCameraFrameEvent_CameraNodeProcessingDetails::operator==(const AndroidCameraFrameEvent_CameraNodeProcessingDetails& other) const {
  return unknown_fields_ == other.unknown_fields_
   && node_id_ == other.node_id_
   && start_processing_ns_ == other.start_processing_ns_
   && end_processing_ns_ == other.end_processing_ns_
   && scheduling_latency_ns_ == other.scheduling_latency_ns_;
}
