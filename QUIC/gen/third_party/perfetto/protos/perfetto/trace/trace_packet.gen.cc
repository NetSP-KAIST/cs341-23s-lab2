...
bool TracePacket::operator==(const TracePacket& other) const {
  return unknown_fields_ == other.unknown_fields_
   ...
   && android_energy_estimation_breakdown_ == other.android_energy_estimation_breakdown_
   && ui_state_ == other.ui_state_
   && android_camera_frame_event_ == other.android_camera_frame_event_
   && android_camera_session_stats_ == other.android_camera_session_stats_
   && translation_table_ == other.translation_table_
   ...
   && trusted_pid_ == other.trusted_pid_
   ...
   && first_packet_on_sequence_ == other.first_packet_on_sequence_;
}
