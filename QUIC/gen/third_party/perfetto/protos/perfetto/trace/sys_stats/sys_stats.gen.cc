...
bool SysStats::operator==(const SysStats& other) const {
  return unknown_fields_ == other.unknown_fields_
   ...
   && cpufreq_khz_ == other.cpufreq_khz_
   && buddy_info_ == other.buddy_info_
   && disk_stat_ == other.disk_stat_;
}
...
bool SysStats_DiskStat::operator==(const SysStats_DiskStat& other) const {
  return unknown_fields_ == other.unknown_fields_
   ...
   && read_sectors_ == other.read_sectors_
   && read_time_ms_ == other.read_time_ms_
   && write_sectors_ == other.write_sectors_
   && write_time_ms_ == other.write_time_ms_
   && discard_sectors_ == other.discard_sectors_
   && discard_time_ms_ == other.discard_time_ms_
   && flush_count_ == other.flush_count_
   && flush_time_ms_ == other.flush_time_ms_;
}
...
bool SysStats_BuddyInfo::operator==(const SysStats_BuddyInfo& other) const {
  return unknown_fields_ == other.unknown_fields_
   && node_ == other.node_
   && zone_ == other.zone_
   && order_pages_ == other.order_pages_;
}
