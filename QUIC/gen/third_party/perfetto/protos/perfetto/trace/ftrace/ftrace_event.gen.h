...
class PERFETTO_EXPORT_COMPONENT FtraceEvent : public ::protozero::CppMessageObj {
 public:
  enum FieldNumbers {
  ...
  bool has_dma_heap_stat() const { return _has_field_[351]; }
  const DmaHeapStatFtraceEvent& dma_heap_stat() const { return *dma_heap_stat_; }
  DmaHeapStatFtraceEvent* mutable_dma_heap_stat() { _has_field_.set(351); return dma_heap_stat_.get(); }

  bool has_cpuhp_pause() const { return _has_field_[352]; }
  const CpuhpPauseFtraceEvent& cpuhp_pause() const { return *cpuhp_pause_; }
  CpuhpPauseFtraceEvent* mutable_cpuhp_pause() { _has_field_.set(352); return cpuhp_pause_.get(); }

  bool has_sched_pi_setprio() const { return _has_field_[353]; }
  const SchedPiSetprioFtraceEvent& sched_pi_setprio() const { return *sched_pi_setprio_; }
  SchedPiSetprioFtraceEvent* mutable_sched_pi_setprio() { _has_field_.set(353); return sched_pi_setprio_.get(); }

  bool has_sde_sde_evtlog() const { return _has_field_[354]; }
  const SdeSdeEvtlogFtraceEvent& sde_sde_evtlog() const { return *sde_sde_evtlog_; }
  SdeSdeEvtlogFtraceEvent* mutable_sde_sde_evtlog() { _has_field_.set(354); return sde_sde_evtlog_.get(); }

  bool has_sde_sde_perf_calc_crtc() const { return _has_field_[355]; }
  const SdeSdePerfCalcCrtcFtraceEvent& sde_sde_perf_calc_crtc() const { return *sde_sde_perf_calc_crtc_; }
  SdeSdePerfCalcCrtcFtraceEvent* mutable_sde_sde_perf_calc_crtc() { _has_field_.set(355); return sde_sde_perf_calc_crtc_.get(); }

  bool has_sde_sde_perf_crtc_update() const { return _has_field_[356]; }
  const SdeSdePerfCrtcUpdateFtraceEvent& sde_sde_perf_crtc_update() const { return *sde_sde_perf_crtc_update_; }
  SdeSdePerfCrtcUpdateFtraceEvent* mutable_sde_sde_perf_crtc_update() { _has_field_.set(356); return sde_sde_perf_crtc_update_.get(); }

  bool has_sde_sde_perf_set_qos_luts() const { return _has_field_[357]; }
  const SdeSdePerfSetQosLutsFtraceEvent& sde_sde_perf_set_qos_luts() const { return *sde_sde_perf_set_qos_luts_; }
  SdeSdePerfSetQosLutsFtraceEvent* mutable_sde_sde_perf_set_qos_luts() { _has_field_.set(357); return sde_sde_perf_set_qos_luts_.get(); }

  bool has_sde_sde_perf_update_bus() const { return _has_field_[358]; }
  const SdeSdePerfUpdateBusFtraceEvent& sde_sde_perf_update_bus() const { return *sde_sde_perf_update_bus_; }
  SdeSdePerfUpdateBusFtraceEvent* mutable_sde_sde_perf_update_bus() { _has_field_.set(358); return sde_sde_perf_update_bus_.get(); }

  bool has_rss_stat_throttled() const { return _has_field_[359]; }
  const RssStatThrottledFtraceEvent& rss_stat_throttled() const { return *rss_stat_throttled_; }
  RssStatThrottledFtraceEvent* mutable_rss_stat_throttled() { _has_field_.set(359); return rss_stat_throttled_.get(); }

  bool has_netif_receive_skb() const { return _has_field_[360]; }
  const NetifReceiveSkbFtraceEvent& netif_receive_skb() const { return *netif_receive_skb_; }
  NetifReceiveSkbFtraceEvent* mutable_netif_receive_skb() { _has_field_.set(360); return netif_receive_skb_.get(); }

  bool has_net_dev_xmit() const { return _has_field_[361]; }
  const NetDevXmitFtraceEvent& net_dev_xmit() const { return *net_dev_xmit_; }
  NetDevXmitFtraceEvent* mutable_net_dev_xmit() { _has_field_.set(361); return net_dev_xmit_.get(); }

  bool has_inet_sock_set_state() const { return _has_field_[362]; }
  const InetSockSetStateFtraceEvent& inet_sock_set_state() const { return *inet_sock_set_state_; }
  InetSockSetStateFtraceEvent* mutable_inet_sock_set_state() { _has_field_.set(362); return inet_sock_set_state_.get(); }

  bool has_tcp_retransmit_skb() const { return _has_field_[363]; }
  const TcpRetransmitSkbFtraceEvent& tcp_retransmit_skb() const { return *tcp_retransmit_skb_; }
  TcpRetransmitSkbFtraceEvent* mutable_tcp_retransmit_skb() { _has_field_.set(363); return tcp_retransmit_skb_.get(); }

  bool has_cros_ec_sensorhub_data() const { return _has_field_[364]; }
  const CrosEcSensorhubDataFtraceEvent& cros_ec_sensorhub_data() const { return *cros_ec_sensorhub_data_; }
  CrosEcSensorhubDataFtraceEvent* mutable_cros_ec_sensorhub_data() { _has_field_.set(364); return cros_ec_sensorhub_data_.get(); }

  bool has_napi_gro_receive_entry() const { return _has_field_[365]; }
  const NapiGroReceiveEntryFtraceEvent& napi_gro_receive_entry() const { return *napi_gro_receive_entry_; }
  NapiGroReceiveEntryFtraceEvent* mutable_napi_gro_receive_entry() { _has_field_.set(365); return napi_gro_receive_entry_.get(); }

  bool has_napi_gro_receive_exit() const { return _has_field_[366]; }
  const NapiGroReceiveExitFtraceEvent& napi_gro_receive_exit() const { return *napi_gro_receive_exit_; }
  NapiGroReceiveExitFtraceEvent* mutable_napi_gro_receive_exit() { _has_field_.set(366); return napi_gro_receive_exit_.get(); }

  bool has_kfree_skb() const { return _has_field_[367]; }
  const KfreeSkbFtraceEvent& kfree_skb() const { return *kfree_skb_; }
  KfreeSkbFtraceEvent* mutable_kfree_skb() { _has_field_.set(367); return kfree_skb_.get(); }

  bool has_kvm_access_fault() const { return _has_field_[368]; }
  const KvmAccessFaultFtraceEvent& kvm_access_fault() const { return *kvm_access_fault_; }
  KvmAccessFaultFtraceEvent* mutable_kvm_access_fault() { _has_field_.set(368); return kvm_access_fault_.get(); }

  bool has_kvm_ack_irq() const { return _has_field_[369]; }
  const KvmAckIrqFtraceEvent& kvm_ack_irq() const { return *kvm_ack_irq_; }
  KvmAckIrqFtraceEvent* mutable_kvm_ack_irq() { _has_field_.set(369); return kvm_ack_irq_.get(); }

  bool has_kvm_age_hva() const { return _has_field_[370]; }
  const KvmAgeHvaFtraceEvent& kvm_age_hva() const { return *kvm_age_hva_; }
  KvmAgeHvaFtraceEvent* mutable_kvm_age_hva() { _has_field_.set(370); return kvm_age_hva_.get(); }

  bool has_kvm_age_page() const { return _has_field_[371]; }
  const KvmAgePageFtraceEvent& kvm_age_page() const { return *kvm_age_page_; }
  KvmAgePageFtraceEvent* mutable_kvm_age_page() { _has_field_.set(371); return kvm_age_page_.get(); }

  bool has_kvm_arm_clear_debug() const { return _has_field_[372]; }
  const KvmArmClearDebugFtraceEvent& kvm_arm_clear_debug() const { return *kvm_arm_clear_debug_; }
  KvmArmClearDebugFtraceEvent* mutable_kvm_arm_clear_debug() { _has_field_.set(372); return kvm_arm_clear_debug_.get(); }

  bool has_kvm_arm_set_dreg32() const { return _has_field_[373]; }
  const KvmArmSetDreg32FtraceEvent& kvm_arm_set_dreg32() const { return *kvm_arm_set_dreg32_; }
  KvmArmSetDreg32FtraceEvent* mutable_kvm_arm_set_dreg32() { _has_field_.set(373); return kvm_arm_set_dreg32_.get(); }

  bool has_kvm_arm_set_regset() const { return _has_field_[374]; }
  const KvmArmSetRegsetFtraceEvent& kvm_arm_set_regset() const { return *kvm_arm_set_regset_; }
  KvmArmSetRegsetFtraceEvent* mutable_kvm_arm_set_regset() { _has_field_.set(374); return kvm_arm_set_regset_.get(); }

  bool has_kvm_arm_setup_debug() const { return _has_field_[375]; }
  const KvmArmSetupDebugFtraceEvent& kvm_arm_setup_debug() const { return *kvm_arm_setup_debug_; }
  KvmArmSetupDebugFtraceEvent* mutable_kvm_arm_setup_debug() { _has_field_.set(375); return kvm_arm_setup_debug_.get(); }

  bool has_kvm_entry() const { return _has_field_[376]; }
  const KvmEntryFtraceEvent& kvm_entry() const { return *kvm_entry_; }
  KvmEntryFtraceEvent* mutable_kvm_entry() { _has_field_.set(376); return kvm_entry_.get(); }

  bool has_kvm_exit() const { return _has_field_[377]; }
  const KvmExitFtraceEvent& kvm_exit() const { return *kvm_exit_; }
  KvmExitFtraceEvent* mutable_kvm_exit() { _has_field_.set(377); return kvm_exit_.get(); }

  bool has_kvm_fpu() const { return _has_field_[378]; }
  const KvmFpuFtraceEvent& kvm_fpu() const { return *kvm_fpu_; }
  KvmFpuFtraceEvent* mutable_kvm_fpu() { _has_field_.set(378); return kvm_fpu_.get(); }

  bool has_kvm_get_timer_map() const { return _has_field_[379]; }
  const KvmGetTimerMapFtraceEvent& kvm_get_timer_map() const { return *kvm_get_timer_map_; }
  KvmGetTimerMapFtraceEvent* mutable_kvm_get_timer_map() { _has_field_.set(379); return kvm_get_timer_map_.get(); }

  bool has_kvm_guest_fault() const { return _has_field_[380]; }
  const KvmGuestFaultFtraceEvent& kvm_guest_fault() const { return *kvm_guest_fault_; }
  KvmGuestFaultFtraceEvent* mutable_kvm_guest_fault() { _has_field_.set(380); return kvm_guest_fault_.get(); }

  bool has_kvm_handle_sys_reg() const { return _has_field_[381]; }
  const KvmHandleSysRegFtraceEvent& kvm_handle_sys_reg() const { return *kvm_handle_sys_reg_; }
  KvmHandleSysRegFtraceEvent* mutable_kvm_handle_sys_reg() { _has_field_.set(381); return kvm_handle_sys_reg_.get(); }

  bool has_kvm_hvc_arm64() const { return _has_field_[382]; }
  const KvmHvcArm64FtraceEvent& kvm_hvc_arm64() const { return *kvm_hvc_arm64_; }
  KvmHvcArm64FtraceEvent* mutable_kvm_hvc_arm64() { _has_field_.set(382); return kvm_hvc_arm64_.get(); }

  bool has_kvm_irq_line() const { return _has_field_[383]; }
  const KvmIrqLineFtraceEvent& kvm_irq_line() const { return *kvm_irq_line_; }
  KvmIrqLineFtraceEvent* mutable_kvm_irq_line() { _has_field_.set(383); return kvm_irq_line_.get(); }

  bool has_kvm_mmio() const { return _has_field_[384]; }
  const KvmMmioFtraceEvent& kvm_mmio() const { return *kvm_mmio_; }
  KvmMmioFtraceEvent* mutable_kvm_mmio() { _has_field_.set(384); return kvm_mmio_.get(); }

  bool has_kvm_mmio_emulate() const { return _has_field_[385]; }
  const KvmMmioEmulateFtraceEvent& kvm_mmio_emulate() const { return *kvm_mmio_emulate_; }
  KvmMmioEmulateFtraceEvent* mutable_kvm_mmio_emulate() { _has_field_.set(385); return kvm_mmio_emulate_.get(); }

  bool has_kvm_set_guest_debug() const { return _has_field_[386]; }
  const KvmSetGuestDebugFtraceEvent& kvm_set_guest_debug() const { return *kvm_set_guest_debug_; }
  KvmSetGuestDebugFtraceEvent* mutable_kvm_set_guest_debug() { _has_field_.set(386); return kvm_set_guest_debug_.get(); }

  bool has_kvm_set_irq() const { return _has_field_[387]; }
  const KvmSetIrqFtraceEvent& kvm_set_irq() const { return *kvm_set_irq_; }
  KvmSetIrqFtraceEvent* mutable_kvm_set_irq() { _has_field_.set(387); return kvm_set_irq_.get(); }

  bool has_kvm_set_spte_hva() const { return _has_field_[388]; }
  const KvmSetSpteHvaFtraceEvent& kvm_set_spte_hva() const { return *kvm_set_spte_hva_; }
  KvmSetSpteHvaFtraceEvent* mutable_kvm_set_spte_hva() { _has_field_.set(388); return kvm_set_spte_hva_.get(); }

  bool has_kvm_set_way_flush() const { return _has_field_[389]; }
  const KvmSetWayFlushFtraceEvent& kvm_set_way_flush() const { return *kvm_set_way_flush_; }
  KvmSetWayFlushFtraceEvent* mutable_kvm_set_way_flush() { _has_field_.set(389); return kvm_set_way_flush_.get(); }

  bool has_kvm_sys_access() const { return _has_field_[390]; }
  const KvmSysAccessFtraceEvent& kvm_sys_access() const { return *kvm_sys_access_; }
  KvmSysAccessFtraceEvent* mutable_kvm_sys_access() { _has_field_.set(390); return kvm_sys_access_.get(); }

  bool has_kvm_test_age_hva() const { return _has_field_[391]; }
  const KvmTestAgeHvaFtraceEvent& kvm_test_age_hva() const { return *kvm_test_age_hva_; }
  KvmTestAgeHvaFtraceEvent* mutable_kvm_test_age_hva() { _has_field_.set(391); return kvm_test_age_hva_.get(); }

  bool has_kvm_timer_emulate() const { return _has_field_[392]; }
  const KvmTimerEmulateFtraceEvent& kvm_timer_emulate() const { return *kvm_timer_emulate_; }
  KvmTimerEmulateFtraceEvent* mutable_kvm_timer_emulate() { _has_field_.set(392); return kvm_timer_emulate_.get(); }

  bool has_kvm_timer_hrtimer_expire() const { return _has_field_[393]; }
  const KvmTimerHrtimerExpireFtraceEvent& kvm_timer_hrtimer_expire() const { return *kvm_timer_hrtimer_expire_; }
  KvmTimerHrtimerExpireFtraceEvent* mutable_kvm_timer_hrtimer_expire() { _has_field_.set(393); return kvm_timer_hrtimer_expire_.get(); }

  bool has_kvm_timer_restore_state() const { return _has_field_[394]; }
  const KvmTimerRestoreStateFtraceEvent& kvm_timer_restore_state() const { return *kvm_timer_restore_state_; }
  KvmTimerRestoreStateFtraceEvent* mutable_kvm_timer_restore_state() { _has_field_.set(394); return kvm_timer_restore_state_.get(); }

  bool has_kvm_timer_save_state() const { return _has_field_[395]; }
  const KvmTimerSaveStateFtraceEvent& kvm_timer_save_state() const { return *kvm_timer_save_state_; }
  KvmTimerSaveStateFtraceEvent* mutable_kvm_timer_save_state() { _has_field_.set(395); return kvm_timer_save_state_.get(); }

  bool has_kvm_timer_update_irq() const { return _has_field_[396]; }
  const KvmTimerUpdateIrqFtraceEvent& kvm_timer_update_irq() const { return *kvm_timer_update_irq_; }
  KvmTimerUpdateIrqFtraceEvent* mutable_kvm_timer_update_irq() { _has_field_.set(396); return kvm_timer_update_irq_.get(); }

  bool has_kvm_toggle_cache() const { return _has_field_[397]; }
  const KvmToggleCacheFtraceEvent& kvm_toggle_cache() const { return *kvm_toggle_cache_; }
  KvmToggleCacheFtraceEvent* mutable_kvm_toggle_cache() { _has_field_.set(397); return kvm_toggle_cache_.get(); }

  bool has_kvm_unmap_hva_range() const { return _has_field_[398]; }
  const KvmUnmapHvaRangeFtraceEvent& kvm_unmap_hva_range() const { return *kvm_unmap_hva_range_; }
  KvmUnmapHvaRangeFtraceEvent* mutable_kvm_unmap_hva_range() { _has_field_.set(398); return kvm_unmap_hva_range_.get(); }

  bool has_kvm_userspace_exit() const { return _has_field_[399]; }
  const KvmUserspaceExitFtraceEvent& kvm_userspace_exit() const { return *kvm_userspace_exit_; }
  KvmUserspaceExitFtraceEvent* mutable_kvm_userspace_exit() { _has_field_.set(399); return kvm_userspace_exit_.get(); }

  bool has_kvm_vcpu_wakeup() const { return _has_field_[400]; }
  const KvmVcpuWakeupFtraceEvent& kvm_vcpu_wakeup() const { return *kvm_vcpu_wakeup_; }
  KvmVcpuWakeupFtraceEvent* mutable_kvm_vcpu_wakeup() { _has_field_.set(400); return kvm_vcpu_wakeup_.get(); }

  bool has_kvm_wfx_arm64() const { return _has_field_[401]; }
  const KvmWfxArm64FtraceEvent& kvm_wfx_arm64() const { return *kvm_wfx_arm64_; }
  KvmWfxArm64FtraceEvent* mutable_kvm_wfx_arm64() { _has_field_.set(401); return kvm_wfx_arm64_.get(); }

  bool has_trap_reg() const { return _has_field_[402]; }
  const TrapRegFtraceEvent& trap_reg() const { return *trap_reg_; }
  TrapRegFtraceEvent* mutable_trap_reg() { _has_field_.set(402); return trap_reg_.get(); }

  bool has_vgic_update_irq_pending() const { return _has_field_[403]; }
  const VgicUpdateIrqPendingFtraceEvent& vgic_update_irq_pending() const { return *vgic_update_irq_pending_; }
  VgicUpdateIrqPendingFtraceEvent* mutable_vgic_update_irq_pending() { _has_field_.set(403); return vgic_update_irq_pending_.get(); }

  bool has_wakeup_source_activate() const { return _has_field_[404]; }
  const WakeupSourceActivateFtraceEvent& wakeup_source_activate() const { return *wakeup_source_activate_; }
  WakeupSourceActivateFtraceEvent* mutable_wakeup_source_activate() { _has_field_.set(404); return wakeup_source_activate_.get(); }

  bool has_wakeup_source_deactivate() const { return _has_field_[405]; }
  const WakeupSourceDeactivateFtraceEvent& wakeup_source_deactivate() const { return *wakeup_source_deactivate_; }
  WakeupSourceDeactivateFtraceEvent* mutable_wakeup_source_deactivate() { _has_field_.set(405); return wakeup_source_deactivate_.get(); }

  bool has_ufshcd_command() const { return _has_field_[406]; }
  const UfshcdCommandFtraceEvent& ufshcd_command() const { return *ufshcd_command_; }
  UfshcdCommandFtraceEvent* mutable_ufshcd_command() { _has_field_.set(406); return ufshcd_command_.get(); }

  bool has_ufshcd_clk_gating() const { return _has_field_[407]; }
  const UfshcdClkGatingFtraceEvent& ufshcd_clk_gating() const { return *ufshcd_clk_gating_; }
  UfshcdClkGatingFtraceEvent* mutable_ufshcd_clk_gating() { _has_field_.set(407); return ufshcd_clk_gating_.get(); }

  bool has_console() const { return _has_field_[408]; }
  const ConsoleFtraceEvent& console() const { return *console_; }
  ConsoleFtraceEvent* mutable_console() { _has_field_.set(408); return console_.get(); }

  bool has_drm_vblank_event() const { return _has_field_[409]; }
  const DrmVblankEventFtraceEvent& drm_vblank_event() const { return *drm_vblank_event_; }
  DrmVblankEventFtraceEvent* mutable_drm_vblank_event() { _has_field_.set(409); return drm_vblank_event_.get(); }

  bool has_drm_vblank_event_delivered() const { return _has_field_[410]; }
  const DrmVblankEventDeliveredFtraceEvent& drm_vblank_event_delivered() const { return *drm_vblank_event_delivered_; }
  DrmVblankEventDeliveredFtraceEvent* mutable_drm_vblank_event_delivered() { _has_field_.set(410); return drm_vblank_event_delivered_.get(); }

  bool has_drm_sched_job() const { return _has_field_[411]; }
  const DrmSchedJobFtraceEvent& drm_sched_job() const { return *drm_sched_job_; }
  DrmSchedJobFtraceEvent* mutable_drm_sched_job() { _has_field_.set(411); return drm_sched_job_.get(); }

  bool has_drm_run_job() const { return _has_field_[412]; }
  const DrmRunJobFtraceEvent& drm_run_job() const { return *drm_run_job_; }
  DrmRunJobFtraceEvent* mutable_drm_run_job() { _has_field_.set(412); return drm_run_job_.get(); }

  bool has_drm_sched_process_job() const { return _has_field_[413]; }
  const DrmSchedProcessJobFtraceEvent& drm_sched_process_job() const { return *drm_sched_process_job_; }
  DrmSchedProcessJobFtraceEvent* mutable_drm_sched_process_job() { _has_field_.set(413); return drm_sched_process_job_.get(); }

  bool has_dma_fence_init() const { return _has_field_[414]; }
  const DmaFenceInitFtraceEvent& dma_fence_init() const { return *dma_fence_init_; }
  DmaFenceInitFtraceEvent* mutable_dma_fence_init() { _has_field_.set(414); return dma_fence_init_.get(); }

  bool has_dma_fence_emit() const { return _has_field_[415]; }
  const DmaFenceEmitFtraceEvent& dma_fence_emit() const { return *dma_fence_emit_; }
  DmaFenceEmitFtraceEvent* mutable_dma_fence_emit() { _has_field_.set(415); return dma_fence_emit_.get(); }

  bool has_dma_fence_signaled() const { return _has_field_[416]; }
  const DmaFenceSignaledFtraceEvent& dma_fence_signaled() const { return *dma_fence_signaled_; }
  DmaFenceSignaledFtraceEvent* mutable_dma_fence_signaled() { _has_field_.set(416); return dma_fence_signaled_.get(); }

  bool has_dma_fence_wait_start() const { return _has_field_[417]; }
  const DmaFenceWaitStartFtraceEvent& dma_fence_wait_start() const { return *dma_fence_wait_start_; }
  DmaFenceWaitStartFtraceEvent* mutable_dma_fence_wait_start() { _has_field_.set(417); return dma_fence_wait_start_.get(); }

  bool has_dma_fence_wait_end() const { return _has_field_[418]; }
  const DmaFenceWaitEndFtraceEvent& dma_fence_wait_end() const { return *dma_fence_wait_end_; }
  DmaFenceWaitEndFtraceEvent* mutable_dma_fence_wait_end() { _has_field_.set(418); return dma_fence_wait_end_.get(); }

  bool has_f2fs_iostat() const { return _has_field_[419]; }
  const F2fsIostatFtraceEvent& f2fs_iostat() const { return *f2fs_iostat_; }
  F2fsIostatFtraceEvent* mutable_f2fs_iostat() { _has_field_.set(419); return f2fs_iostat_.get(); }

  bool has_f2fs_iostat_latency() const { return _has_field_[420]; }
  const F2fsIostatLatencyFtraceEvent& f2fs_iostat_latency() const { return *f2fs_iostat_latency_; }
  F2fsIostatLatencyFtraceEvent* mutable_f2fs_iostat_latency() { _has_field_.set(420); return f2fs_iostat_latency_.get(); }

  bool has_sched_cpu_util_cfs() const { return _has_field_[421]; }
  const SchedCpuUtilCfsFtraceEvent& sched_cpu_util_cfs() const { return *sched_cpu_util_cfs_; }
  SchedCpuUtilCfsFtraceEvent* mutable_sched_cpu_util_cfs() { _has_field_.set(421); return sched_cpu_util_cfs_.get(); }

  bool has_v4l2_qbuf() const { return _has_field_[422]; }
  const V4l2QbufFtraceEvent& v4l2_qbuf() const { return *v4l2_qbuf_; }
  V4l2QbufFtraceEvent* mutable_v4l2_qbuf() { _has_field_.set(422); return v4l2_qbuf_.get(); }

  bool has_v4l2_dqbuf() const { return _has_field_[423]; }
  const V4l2DqbufFtraceEvent& v4l2_dqbuf() const { return *v4l2_dqbuf_; }
  V4l2DqbufFtraceEvent* mutable_v4l2_dqbuf() { _has_field_.set(423); return v4l2_dqbuf_.get(); }

  bool has_vb2_v4l2_buf_queue() const { return _has_field_[424]; }
  const Vb2V4l2BufQueueFtraceEvent& vb2_v4l2_buf_queue() const { return *vb2_v4l2_buf_queue_; }
  Vb2V4l2BufQueueFtraceEvent* mutable_vb2_v4l2_buf_queue() { _has_field_.set(424); return vb2_v4l2_buf_queue_.get(); }

  bool has_vb2_v4l2_buf_done() const { return _has_field_[425]; }
  const Vb2V4l2BufDoneFtraceEvent& vb2_v4l2_buf_done() const { return *vb2_v4l2_buf_done_; }
  Vb2V4l2BufDoneFtraceEvent* mutable_vb2_v4l2_buf_done() { _has_field_.set(425); return vb2_v4l2_buf_done_.get(); }

  bool has_vb2_v4l2_qbuf() const { return _has_field_[426]; }
  const Vb2V4l2QbufFtraceEvent& vb2_v4l2_qbuf() const { return *vb2_v4l2_qbuf_; }
  Vb2V4l2QbufFtraceEvent* mutable_vb2_v4l2_qbuf() { _has_field_.set(426); return vb2_v4l2_qbuf_.get(); }

  bool has_vb2_v4l2_dqbuf() const { return _has_field_[427]; }
  const Vb2V4l2DqbufFtraceEvent& vb2_v4l2_dqbuf() const { return *vb2_v4l2_dqbuf_; }
  Vb2V4l2DqbufFtraceEvent* mutable_vb2_v4l2_dqbuf() { _has_field_.set(427); return vb2_v4l2_dqbuf_.get(); }

  bool has_dsi_cmd_fifo_status() const { return _has_field_[428]; }
  const DsiCmdFifoStatusFtraceEvent& dsi_cmd_fifo_status() const { return *dsi_cmd_fifo_status_; }
  DsiCmdFifoStatusFtraceEvent* mutable_dsi_cmd_fifo_status() { _has_field_.set(428); return dsi_cmd_fifo_status_.get(); }

  bool has_dsi_rx() const { return _has_field_[429]; }
  const DsiRxFtraceEvent& dsi_rx() const { return *dsi_rx_; }
  DsiRxFtraceEvent* mutable_dsi_rx() { _has_field_.set(429); return dsi_rx_.get(); }

  bool has_dsi_tx() const { return _has_field_[430]; }
  const DsiTxFtraceEvent& dsi_tx() const { return *dsi_tx_; }
  DsiTxFtraceEvent* mutable_dsi_tx() { _has_field_.set(430); return dsi_tx_.get(); }

  bool has_android_fs_dataread_end() const { return _has_field_[431]; }
  const AndroidFsDatareadEndFtraceEvent& android_fs_dataread_end() const { return *android_fs_dataread_end_; }
  AndroidFsDatareadEndFtraceEvent* mutable_android_fs_dataread_end() { _has_field_.set(431); return android_fs_dataread_end_.get(); }

  bool has_android_fs_dataread_start() const { return _has_field_[432]; }
  const AndroidFsDatareadStartFtraceEvent& android_fs_dataread_start() const { return *android_fs_dataread_start_; }
  AndroidFsDatareadStartFtraceEvent* mutable_android_fs_dataread_start() { _has_field_.set(432); return android_fs_dataread_start_.get(); }

  bool has_android_fs_datawrite_end() const { return _has_field_[433]; }
  const AndroidFsDatawriteEndFtraceEvent& android_fs_datawrite_end() const { return *android_fs_datawrite_end_; }
  AndroidFsDatawriteEndFtraceEvent* mutable_android_fs_datawrite_end() { _has_field_.set(433); return android_fs_datawrite_end_.get(); }

  bool has_android_fs_datawrite_start() const { return _has_field_[434]; }
  const AndroidFsDatawriteStartFtraceEvent& android_fs_datawrite_start() const { return *android_fs_datawrite_start_; }
  AndroidFsDatawriteStartFtraceEvent* mutable_android_fs_datawrite_start() { _has_field_.set(434); return android_fs_datawrite_start_.get(); }

  bool has_android_fs_fsync_end() const { return _has_field_[435]; }
  const AndroidFsFsyncEndFtraceEvent& android_fs_fsync_end() const { return *android_fs_fsync_end_; }
  AndroidFsFsyncEndFtraceEvent* mutable_android_fs_fsync_end() { _has_field_.set(435); return android_fs_fsync_end_.get(); }

  bool has_android_fs_fsync_start() const { return _has_field_[436]; }
  const AndroidFsFsyncStartFtraceEvent& android_fs_fsync_start() const { return *android_fs_fsync_start_; }
  AndroidFsFsyncStartFtraceEvent* mutable_android_fs_fsync_start() { _has_field_.set(436); return android_fs_fsync_start_.get(); }

  bool has_funcgraph_entry() const { return _has_field_[437]; }
  const FuncgraphEntryFtraceEvent& funcgraph_entry() const { return *funcgraph_entry_; }
  FuncgraphEntryFtraceEvent* mutable_funcgraph_entry() { _has_field_.set(437); return funcgraph_entry_.get(); }

  bool has_funcgraph_exit() const { return _has_field_[438]; }
  const FuncgraphExitFtraceEvent& funcgraph_exit() const { return *funcgraph_exit_; }
  FuncgraphExitFtraceEvent* mutable_funcgraph_exit() { _has_field_.set(438); return funcgraph_exit_.get(); }

  bool has_virtio_video_cmd() const { return _has_field_[439]; }
  const VirtioVideoCmdFtraceEvent& virtio_video_cmd() const { return *virtio_video_cmd_; }
  VirtioVideoCmdFtraceEvent* mutable_virtio_video_cmd() { _has_field_.set(439); return virtio_video_cmd_.get(); }

  bool has_virtio_video_cmd_done() const { return _has_field_[440]; }
  const VirtioVideoCmdDoneFtraceEvent& virtio_video_cmd_done() const { return *virtio_video_cmd_done_; }
  VirtioVideoCmdDoneFtraceEvent* mutable_virtio_video_cmd_done() { _has_field_.set(440); return virtio_video_cmd_done_.get(); }

  bool has_virtio_video_resource_queue() const { return _has_field_[441]; }
  const VirtioVideoResourceQueueFtraceEvent& virtio_video_resource_queue() const { return *virtio_video_resource_queue_; }
  VirtioVideoResourceQueueFtraceEvent* mutable_virtio_video_resource_queue() { _has_field_.set(441); return virtio_video_resource_queue_.get(); }

  bool has_virtio_video_resource_queue_done() const { return _has_field_[442]; }
  const VirtioVideoResourceQueueDoneFtraceEvent& virtio_video_resource_queue_done() const { return *virtio_video_resource_queue_done_; }
  VirtioVideoResourceQueueDoneFtraceEvent* mutable_virtio_video_resource_queue_done() { _has_field_.set(442); return virtio_video_resource_queue_done_.get(); }

  bool has_mm_shrink_slab_start() const { return _has_field_[443]; }
  const MmShrinkSlabStartFtraceEvent& mm_shrink_slab_start() const { return *mm_shrink_slab_start_; }
  MmShrinkSlabStartFtraceEvent* mutable_mm_shrink_slab_start() { _has_field_.set(443); return mm_shrink_slab_start_.get(); }

  bool has_mm_shrink_slab_end() const { return _has_field_[444]; }
  const MmShrinkSlabEndFtraceEvent& mm_shrink_slab_end() const { return *mm_shrink_slab_end_; }
  MmShrinkSlabEndFtraceEvent* mutable_mm_shrink_slab_end() { _has_field_.set(444); return mm_shrink_slab_end_.get(); }

  bool has_trusty_smc() const { return _has_field_[445]; }
  const TrustySmcFtraceEvent& trusty_smc() const { return *trusty_smc_; }
  TrustySmcFtraceEvent* mutable_trusty_smc() { _has_field_.set(445); return trusty_smc_.get(); }

  bool has_trusty_smc_done() const { return _has_field_[446]; }
  const TrustySmcDoneFtraceEvent& trusty_smc_done() const { return *trusty_smc_done_; }
  TrustySmcDoneFtraceEvent* mutable_trusty_smc_done() { _has_field_.set(446); return trusty_smc_done_.get(); }

  bool has_trusty_std_call32() const { return _has_field_[447]; }
  const TrustyStdCall32FtraceEvent& trusty_std_call32() const { return *trusty_std_call32_; }
  TrustyStdCall32FtraceEvent* mutable_trusty_std_call32() { _has_field_.set(447); return trusty_std_call32_.get(); }

  bool has_trusty_std_call32_done() const { return _has_field_[448]; }
  const TrustyStdCall32DoneFtraceEvent& trusty_std_call32_done() const { return *trusty_std_call32_done_; }
  TrustyStdCall32DoneFtraceEvent* mutable_trusty_std_call32_done() { _has_field_.set(448); return trusty_std_call32_done_.get(); }

  bool has_trusty_share_memory() const { return _has_field_[449]; }
  const TrustyShareMemoryFtraceEvent& trusty_share_memory() const { return *trusty_share_memory_; }
  TrustyShareMemoryFtraceEvent* mutable_trusty_share_memory() { _has_field_.set(449); return trusty_share_memory_.get(); }

  bool has_trusty_share_memory_done() const { return _has_field_[450]; }
  const TrustyShareMemoryDoneFtraceEvent& trusty_share_memory_done() const { return *trusty_share_memory_done_; }
  TrustyShareMemoryDoneFtraceEvent* mutable_trusty_share_memory_done() { _has_field_.set(450); return trusty_share_memory_done_.get(); }

  bool has_trusty_reclaim_memory() const { return _has_field_[451]; }
  const TrustyReclaimMemoryFtraceEvent& trusty_reclaim_memory() const { return *trusty_reclaim_memory_; }
  TrustyReclaimMemoryFtraceEvent* mutable_trusty_reclaim_memory() { _has_field_.set(451); return trusty_reclaim_memory_.get(); }

  bool has_trusty_reclaim_memory_done() const { return _has_field_[452]; }
  const TrustyReclaimMemoryDoneFtraceEvent& trusty_reclaim_memory_done() const { return *trusty_reclaim_memory_done_; }
  TrustyReclaimMemoryDoneFtraceEvent* mutable_trusty_reclaim_memory_done() { _has_field_.set(452); return trusty_reclaim_memory_done_.get(); }

  bool has_trusty_irq() const { return _has_field_[453]; }
  const TrustyIrqFtraceEvent& trusty_irq() const { return *trusty_irq_; }
  TrustyIrqFtraceEvent* mutable_trusty_irq() { _has_field_.set(453); return trusty_irq_.get(); }

  bool has_trusty_ipc_handle_event() const { return _has_field_[454]; }
  const TrustyIpcHandleEventFtraceEvent& trusty_ipc_handle_event() const { return *trusty_ipc_handle_event_; }
  TrustyIpcHandleEventFtraceEvent* mutable_trusty_ipc_handle_event() { _has_field_.set(454); return trusty_ipc_handle_event_.get(); }

  bool has_trusty_ipc_connect() const { return _has_field_[455]; }
  const TrustyIpcConnectFtraceEvent& trusty_ipc_connect() const { return *trusty_ipc_connect_; }
  TrustyIpcConnectFtraceEvent* mutable_trusty_ipc_connect() { _has_field_.set(455); return trusty_ipc_connect_.get(); }

  bool has_trusty_ipc_connect_end() const { return _has_field_[456]; }
  const TrustyIpcConnectEndFtraceEvent& trusty_ipc_connect_end() const { return *trusty_ipc_connect_end_; }
  TrustyIpcConnectEndFtraceEvent* mutable_trusty_ipc_connect_end() { _has_field_.set(456); return trusty_ipc_connect_end_.get(); }

  bool has_trusty_ipc_write() const { return _has_field_[457]; }
  const TrustyIpcWriteFtraceEvent& trusty_ipc_write() const { return *trusty_ipc_write_; }
  TrustyIpcWriteFtraceEvent* mutable_trusty_ipc_write() { _has_field_.set(457); return trusty_ipc_write_.get(); }

  bool has_trusty_ipc_poll() const { return _has_field_[458]; }
  const TrustyIpcPollFtraceEvent& trusty_ipc_poll() const { return *trusty_ipc_poll_; }
  TrustyIpcPollFtraceEvent* mutable_trusty_ipc_poll() { _has_field_.set(458); return trusty_ipc_poll_.get(); }

  bool has_trusty_ipc_read() const { return _has_field_[460]; }
  const TrustyIpcReadFtraceEvent& trusty_ipc_read() const { return *trusty_ipc_read_; }
  TrustyIpcReadFtraceEvent* mutable_trusty_ipc_read() { _has_field_.set(460); return trusty_ipc_read_.get(); }

  bool has_trusty_ipc_read_end() const { return _has_field_[461]; }
  const TrustyIpcReadEndFtraceEvent& trusty_ipc_read_end() const { return *trusty_ipc_read_end_; }
  TrustyIpcReadEndFtraceEvent* mutable_trusty_ipc_read_end() { _has_field_.set(461); return trusty_ipc_read_end_.get(); }

  bool has_trusty_ipc_rx() const { return _has_field_[462]; }
  const TrustyIpcRxFtraceEvent& trusty_ipc_rx() const { return *trusty_ipc_rx_; }
  TrustyIpcRxFtraceEvent* mutable_trusty_ipc_rx() { _has_field_.set(462); return trusty_ipc_rx_.get(); }

  bool has_trusty_enqueue_nop() const { return _has_field_[464]; }
  const TrustyEnqueueNopFtraceEvent& trusty_enqueue_nop() const { return *trusty_enqueue_nop_; }
  TrustyEnqueueNopFtraceEvent* mutable_trusty_enqueue_nop() { _has_field_.set(464); return trusty_enqueue_nop_.get(); }

  bool has_cma_alloc_start() const { return _has_field_[465]; }
  const CmaAllocStartFtraceEvent& cma_alloc_start() const { return *cma_alloc_start_; }
  CmaAllocStartFtraceEvent* mutable_cma_alloc_start() { _has_field_.set(465); return cma_alloc_start_.get(); }

  bool has_cma_alloc_info() const { return _has_field_[466]; }
  const CmaAllocInfoFtraceEvent& cma_alloc_info() const { return *cma_alloc_info_; }
  CmaAllocInfoFtraceEvent* mutable_cma_alloc_info() { _has_field_.set(466); return cma_alloc_info_.get(); }

  bool has_lwis_tracing_mark_write() const { return _has_field_[467]; }
  const LwisTracingMarkWriteFtraceEvent& lwis_tracing_mark_write() const { return *lwis_tracing_mark_write_; }
  LwisTracingMarkWriteFtraceEvent* mutable_lwis_tracing_mark_write() { _has_field_.set(467); return lwis_tracing_mark_write_.get(); }

  bool has_virtio_gpu_cmd_queue() const { return _has_field_[468]; }
  const VirtioGpuCmdQueueFtraceEvent& virtio_gpu_cmd_queue() const { return *virtio_gpu_cmd_queue_; }
  VirtioGpuCmdQueueFtraceEvent* mutable_virtio_gpu_cmd_queue() { _has_field_.set(468); return virtio_gpu_cmd_queue_.get(); }

  bool has_virtio_gpu_cmd_response() const { return _has_field_[469]; }
  const VirtioGpuCmdResponseFtraceEvent& virtio_gpu_cmd_response() const { return *virtio_gpu_cmd_response_; }
  VirtioGpuCmdResponseFtraceEvent* mutable_virtio_gpu_cmd_response() { _has_field_.set(469); return virtio_gpu_cmd_response_.get(); }

  bool has_mali_mali_kcpu_cqs_set() const { return _has_field_[470]; }
  const MaliMaliKCPUCQSSETFtraceEvent& mali_mali_kcpu_cqs_set() const { return *mali_mali_kcpu_cqs_set_; }
  MaliMaliKCPUCQSSETFtraceEvent* mutable_mali_mali_kcpu_cqs_set() { _has_field_.set(470); return mali_mali_kcpu_cqs_set_.get(); }

  bool has_mali_mali_kcpu_cqs_wait_start() const { return _has_field_[471]; }
  const MaliMaliKCPUCQSWAITSTARTFtraceEvent& mali_mali_kcpu_cqs_wait_start() const { return *mali_mali_kcpu_cqs_wait_start_; }
  MaliMaliKCPUCQSWAITSTARTFtraceEvent* mutable_mali_mali_kcpu_cqs_wait_start() { _has_field_.set(471); return mali_mali_kcpu_cqs_wait_start_.get(); }

  bool has_mali_mali_kcpu_cqs_wait_end() const { return _has_field_[472]; }
  const MaliMaliKCPUCQSWAITENDFtraceEvent& mali_mali_kcpu_cqs_wait_end() const { return *mali_mali_kcpu_cqs_wait_end_; }
  MaliMaliKCPUCQSWAITENDFtraceEvent* mutable_mali_mali_kcpu_cqs_wait_end() { _has_field_.set(472); return mali_mali_kcpu_cqs_wait_end_.get(); }

  bool has_mali_mali_kcpu_fence_signal() const { return _has_field_[473]; }
  const MaliMaliKCPUFENCESIGNALFtraceEvent& mali_mali_kcpu_fence_signal() const { return *mali_mali_kcpu_fence_signal_; }
  MaliMaliKCPUFENCESIGNALFtraceEvent* mutable_mali_mali_kcpu_fence_signal() { _has_field_.set(473); return mali_mali_kcpu_fence_signal_.get(); }

  bool has_mali_mali_kcpu_fence_wait_start() const { return _has_field_[474]; }
  const MaliMaliKCPUFENCEWAITSTARTFtraceEvent& mali_mali_kcpu_fence_wait_start() const { return *mali_mali_kcpu_fence_wait_start_; }
  MaliMaliKCPUFENCEWAITSTARTFtraceEvent* mutable_mali_mali_kcpu_fence_wait_start() { _has_field_.set(474); return mali_mali_kcpu_fence_wait_start_.get(); }

  bool has_mali_mali_kcpu_fence_wait_end() const { return _has_field_[475]; }
 ...
 private:
  ...
  ::protozero::CopyablePtr<DmaHeapStatFtraceEvent> dma_heap_stat_;
  ::protozero::CopyablePtr<CpuhpPauseFtraceEvent> cpuhp_pause_;
  ::protozero::CopyablePtr<SchedPiSetprioFtraceEvent> sched_pi_setprio_;
  ::protozero::CopyablePtr<SdeSdeEvtlogFtraceEvent> sde_sde_evtlog_;
  ::protozero::CopyablePtr<SdeSdePerfCalcCrtcFtraceEvent> sde_sde_perf_calc_crtc_;
  ::protozero::CopyablePtr<SdeSdePerfCrtcUpdateFtraceEvent> sde_sde_perf_crtc_update_;
  ::protozero::CopyablePtr<SdeSdePerfSetQosLutsFtraceEvent> sde_sde_perf_set_qos_luts_;
  ::protozero::CopyablePtr<SdeSdePerfUpdateBusFtraceEvent> sde_sde_perf_update_bus_;
  ::protozero::CopyablePtr<RssStatThrottledFtraceEvent> rss_stat_throttled_;
  ::protozero::CopyablePtr<NetifReceiveSkbFtraceEvent> netif_receive_skb_;
  ::protozero::CopyablePtr<NetDevXmitFtraceEvent> net_dev_xmit_;
  ::protozero::CopyablePtr<InetSockSetStateFtraceEvent> inet_sock_set_state_;
  ::protozero::CopyablePtr<TcpRetransmitSkbFtraceEvent> tcp_retransmit_skb_;
  ::protozero::CopyablePtr<CrosEcSensorhubDataFtraceEvent> cros_ec_sensorhub_data_;
  ::protozero::CopyablePtr<NapiGroReceiveEntryFtraceEvent> napi_gro_receive_entry_;
  ::protozero::CopyablePtr<NapiGroReceiveExitFtraceEvent> napi_gro_receive_exit_;
  ::protozero::CopyablePtr<KfreeSkbFtraceEvent> kfree_skb_;
  ::protozero::CopyablePtr<KvmAccessFaultFtraceEvent> kvm_access_fault_;
  ::protozero::CopyablePtr<KvmAckIrqFtraceEvent> kvm_ack_irq_;
  ::protozero::CopyablePtr<KvmAgeHvaFtraceEvent> kvm_age_hva_;
  ::protozero::CopyablePtr<KvmAgePageFtraceEvent> kvm_age_page_;
  ::protozero::CopyablePtr<KvmArmClearDebugFtraceEvent> kvm_arm_clear_debug_;
  ::protozero::CopyablePtr<KvmArmSetDreg32FtraceEvent> kvm_arm_set_dreg32_;
  ::protozero::CopyablePtr<KvmArmSetRegsetFtraceEvent> kvm_arm_set_regset_;
  ::protozero::CopyablePtr<KvmArmSetupDebugFtraceEvent> kvm_arm_setup_debug_;
  ::protozero::CopyablePtr<KvmEntryFtraceEvent> kvm_entry_;
  ::protozero::CopyablePtr<KvmExitFtraceEvent> kvm_exit_;
  ::protozero::CopyablePtr<KvmFpuFtraceEvent> kvm_fpu_;
  ::protozero::CopyablePtr<KvmGetTimerMapFtraceEvent> kvm_get_timer_map_;
  ::protozero::CopyablePtr<KvmGuestFaultFtraceEvent> kvm_guest_fault_;
  ::protozero::CopyablePtr<KvmHandleSysRegFtraceEvent> kvm_handle_sys_reg_;
  ::protozero::CopyablePtr<KvmHvcArm64FtraceEvent> kvm_hvc_arm64_;
  ::protozero::CopyablePtr<KvmIrqLineFtraceEvent> kvm_irq_line_;
  ::protozero::CopyablePtr<KvmMmioFtraceEvent> kvm_mmio_;
  ::protozero::CopyablePtr<KvmMmioEmulateFtraceEvent> kvm_mmio_emulate_;
  ::protozero::CopyablePtr<KvmSetGuestDebugFtraceEvent> kvm_set_guest_debug_;
  ::protozero::CopyablePtr<KvmSetIrqFtraceEvent> kvm_set_irq_;
  ::protozero::CopyablePtr<KvmSetSpteHvaFtraceEvent> kvm_set_spte_hva_;
  ::protozero::CopyablePtr<KvmSetWayFlushFtraceEvent> kvm_set_way_flush_;
  ::protozero::CopyablePtr<KvmSysAccessFtraceEvent> kvm_sys_access_;
  ::protozero::CopyablePtr<KvmTestAgeHvaFtraceEvent> kvm_test_age_hva_;
  ::protozero::CopyablePtr<KvmTimerEmulateFtraceEvent> kvm_timer_emulate_;
  ::protozero::CopyablePtr<KvmTimerHrtimerExpireFtraceEvent> kvm_timer_hrtimer_expire_;
  ::protozero::CopyablePtr<KvmTimerRestoreStateFtraceEvent> kvm_timer_restore_state_;
  ::protozero::CopyablePtr<KvmTimerSaveStateFtraceEvent> kvm_timer_save_state_;
  ::protozero::CopyablePtr<KvmTimerUpdateIrqFtraceEvent> kvm_timer_update_irq_;
  ::protozero::CopyablePtr<KvmToggleCacheFtraceEvent> kvm_toggle_cache_;
  ::protozero::CopyablePtr<KvmUnmapHvaRangeFtraceEvent> kvm_unmap_hva_range_;
  ::protozero::CopyablePtr<KvmUserspaceExitFtraceEvent> kvm_userspace_exit_;
  ::protozero::CopyablePtr<KvmVcpuWakeupFtraceEvent> kvm_vcpu_wakeup_;
  ::protozero::CopyablePtr<KvmWfxArm64FtraceEvent> kvm_wfx_arm64_;
  ::protozero::CopyablePtr<TrapRegFtraceEvent> trap_reg_;
  ::protozero::CopyablePtr<VgicUpdateIrqPendingFtraceEvent> vgic_update_irq_pending_;
  ::protozero::CopyablePtr<WakeupSourceActivateFtraceEvent> wakeup_source_activate_;
  ::protozero::CopyablePtr<WakeupSourceDeactivateFtraceEvent> wakeup_source_deactivate_;
  ::protozero::CopyablePtr<UfshcdCommandFtraceEvent> ufshcd_command_;
  ::protozero::CopyablePtr<UfshcdClkGatingFtraceEvent> ufshcd_clk_gating_;
  ::protozero::CopyablePtr<ConsoleFtraceEvent> console_;
  ::protozero::CopyablePtr<DrmVblankEventFtraceEvent> drm_vblank_event_;
  ::protozero::CopyablePtr<DrmVblankEventDeliveredFtraceEvent> drm_vblank_event_delivered_;
  ::protozero::CopyablePtr<DrmSchedJobFtraceEvent> drm_sched_job_;
  ::protozero::CopyablePtr<DrmRunJobFtraceEvent> drm_run_job_;
  ::protozero::CopyablePtr<DrmSchedProcessJobFtraceEvent> drm_sched_process_job_;
  ::protozero::CopyablePtr<DmaFenceInitFtraceEvent> dma_fence_init_;
  ::protozero::CopyablePtr<DmaFenceEmitFtraceEvent> dma_fence_emit_;
  ::protozero::CopyablePtr<DmaFenceSignaledFtraceEvent> dma_fence_signaled_;
  ::protozero::CopyablePtr<DmaFenceWaitStartFtraceEvent> dma_fence_wait_start_;
  ::protozero::CopyablePtr<DmaFenceWaitEndFtraceEvent> dma_fence_wait_end_;
  ::protozero::CopyablePtr<F2fsIostatFtraceEvent> f2fs_iostat_;
  ::protozero::CopyablePtr<F2fsIostatLatencyFtraceEvent> f2fs_iostat_latency_;
  ::protozero::CopyablePtr<SchedCpuUtilCfsFtraceEvent> sched_cpu_util_cfs_;
  ::protozero::CopyablePtr<V4l2QbufFtraceEvent> v4l2_qbuf_;
  ::protozero::CopyablePtr<V4l2DqbufFtraceEvent> v4l2_dqbuf_;
  ::protozero::CopyablePtr<Vb2V4l2BufQueueFtraceEvent> vb2_v4l2_buf_queue_;
  ::protozero::CopyablePtr<Vb2V4l2BufDoneFtraceEvent> vb2_v4l2_buf_done_;
  ::protozero::CopyablePtr<Vb2V4l2QbufFtraceEvent> vb2_v4l2_qbuf_;
  ::protozero::CopyablePtr<Vb2V4l2DqbufFtraceEvent> vb2_v4l2_dqbuf_;
  ::protozero::CopyablePtr<DsiCmdFifoStatusFtraceEvent> dsi_cmd_fifo_status_;
  ::protozero::CopyablePtr<DsiRxFtraceEvent> dsi_rx_;
  ::protozero::CopyablePtr<DsiTxFtraceEvent> dsi_tx_;
  ::protozero::CopyablePtr<AndroidFsDatareadEndFtraceEvent> android_fs_dataread_end_;
  ::protozero::CopyablePtr<AndroidFsDatareadStartFtraceEvent> android_fs_dataread_start_;
  ::protozero::CopyablePtr<AndroidFsDatawriteEndFtraceEvent> android_fs_datawrite_end_;
  ::protozero::CopyablePtr<AndroidFsDatawriteStartFtraceEvent> android_fs_datawrite_start_;
  ::protozero::CopyablePtr<AndroidFsFsyncEndFtraceEvent> android_fs_fsync_end_;
  ::protozero::CopyablePtr<AndroidFsFsyncStartFtraceEvent> android_fs_fsync_start_;
  ::protozero::CopyablePtr<FuncgraphEntryFtraceEvent> funcgraph_entry_;
  ::protozero::CopyablePtr<FuncgraphExitFtraceEvent> funcgraph_exit_;
  ::protozero::CopyablePtr<VirtioVideoCmdFtraceEvent> virtio_video_cmd_;
  ::protozero::CopyablePtr<VirtioVideoCmdDoneFtraceEvent> virtio_video_cmd_done_;
  ::protozero::CopyablePtr<VirtioVideoResourceQueueFtraceEvent> virtio_video_resource_queue_;
  ::protozero::CopyablePtr<VirtioVideoResourceQueueDoneFtraceEvent> virtio_video_resource_queue_done_;
  ::protozero::CopyablePtr<MmShrinkSlabStartFtraceEvent> mm_shrink_slab_start_;
  ::protozero::CopyablePtr<MmShrinkSlabEndFtraceEvent> mm_shrink_slab_end_;
  ::protozero::CopyablePtr<TrustySmcFtraceEvent> trusty_smc_;
  ::protozero::CopyablePtr<TrustySmcDoneFtraceEvent> trusty_smc_done_;
  ::protozero::CopyablePtr<TrustyStdCall32FtraceEvent> trusty_std_call32_;
  ::protozero::CopyablePtr<TrustyStdCall32DoneFtraceEvent> trusty_std_call32_done_;
  ::protozero::CopyablePtr<TrustyShareMemoryFtraceEvent> trusty_share_memory_;
  ::protozero::CopyablePtr<TrustyShareMemoryDoneFtraceEvent> trusty_share_memory_done_;
  ::protozero::CopyablePtr<TrustyReclaimMemoryFtraceEvent> trusty_reclaim_memory_;
  ::protozero::CopyablePtr<TrustyReclaimMemoryDoneFtraceEvent> trusty_reclaim_memory_done_;
  ::protozero::CopyablePtr<TrustyIrqFtraceEvent> trusty_irq_;
  ::protozero::CopyablePtr<TrustyIpcHandleEventFtraceEvent> trusty_ipc_handle_event_;
  ::protozero::CopyablePtr<TrustyIpcConnectFtraceEvent> trusty_ipc_connect_;
  ::protozero::CopyablePtr<TrustyIpcConnectEndFtraceEvent> trusty_ipc_connect_end_;
  ::protozero::CopyablePtr<TrustyIpcWriteFtraceEvent> trusty_ipc_write_;
  ::protozero::CopyablePtr<TrustyIpcPollFtraceEvent> trusty_ipc_poll_;
  ::protozero::CopyablePtr<TrustyIpcReadFtraceEvent> trusty_ipc_read_;
  ::protozero::CopyablePtr<TrustyIpcReadEndFtraceEvent> trusty_ipc_read_end_;
  ::protozero::CopyablePtr<TrustyIpcRxFtraceEvent> trusty_ipc_rx_;
  ::protozero::CopyablePtr<TrustyEnqueueNopFtraceEvent> trusty_enqueue_nop_;
  ::protozero::CopyablePtr<CmaAllocStartFtraceEvent> cma_alloc_start_;
  ::protozero::CopyablePtr<CmaAllocInfoFtraceEvent> cma_alloc_info_;
  ::protozero::CopyablePtr<LwisTracingMarkWriteFtraceEvent> lwis_tracing_mark_write_;
  ::protozero::CopyablePtr<VirtioGpuCmdQueueFtraceEvent> virtio_gpu_cmd_queue_;
  ::protozero::CopyablePtr<VirtioGpuCmdResponseFtraceEvent> virtio_gpu_cmd_response_;
  ::protozero::CopyablePtr<MaliMaliKCPUCQSSETFtraceEvent> mali_mali_kcpu_cqs_set_;
  ::protozero::CopyablePtr<MaliMaliKCPUCQSWAITSTARTFtraceEvent> mali_mali_kcpu_cqs_wait_start_;
  ::protozero::CopyablePtr<MaliMaliKCPUCQSWAITENDFtraceEvent> mali_mali_kcpu_cqs_wait_end_;
