...
bool SchedCpuUtilCfsFtraceEvent::operator==(const SchedCpuUtilCfsFtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   ...
   && capacity_orig_ == other.capacity_orig_
   && cpu_ == other.cpu_
   && cpu_importance_ == other.cpu_importance_
   && cpu_util_ == other.cpu_util_
   && exit_lat_ == other.exit_lat_
   && group_capacity_ == other.group_capacity_
   && grp_overutilized_ == other.grp_overutilized_
   && idle_cpu_ == other.idle_cpu_
   && nr_running_ == other.nr_running_
   && spare_cap_ == other.spare_cap_
   && task_fits_ == other.task_fits_
   && wake_group_util_ == other.wake_group_util_
   && wake_util_ == other.wake_util_;
}
...
bool SchedPiSetprioFtraceEvent::operator==(const SchedPiSetprioFtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   && comm_ == other.comm_
   && newprio_ == other.newprio_
   && oldprio_ == other.oldprio_
   && pid_ == other.pid_;
}
