...
void VgicUpdateIrqPendingFtraceEvent::Serialize(::protozero::Message* msg) const {
  ...
  // Field 2: level
  if (_has_field_[2]) {
    msg->AppendVarInt(2, level_);
  }

  // Field 3: vcpu_id
  if (_has_field_[3]) {
    msg->AppendVarInt(3, vcpu_id_);
  }
...
bool TrapRegFtraceEvent::operator==(const TrapRegFtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   ...
   && reg_ == other.reg_
   && write_value_ == other.write_value_;
}
...
void TrapRegFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: fn
  if (_has_field_[1]) {
    msg->AppendString(1, fn_);
  }

  // Field 2: is_write
  if (_has_field_[2]) {
    msg->AppendVarInt(2, is_write_);
  }

  // Field 3: reg
  if (_has_field_[3]) {
    msg->AppendVarInt(3, reg_);
  }

  // Field 4: write_value
  if (_has_field_[4]) {
    msg->AppendVarInt(4, write_value_);
  }
...
bool KvmWfxArm64FtraceEvent::operator==(const KvmWfxArm64FtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   && is_wfe_ == other.is_wfe_
   && vcpu_pc_ == other.vcpu_pc_;
}
...
void KvmWfxArm64FtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: is_wfe
  if (_has_field_[1]) {
    msg->AppendVarInt(1, is_wfe_);
  }

  // Field 2: vcpu_pc
  if (_has_field_[2]) {
    msg->AppendVarInt(2, vcpu_pc_);
  }
...
void KvmVcpuWakeupFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: ns
  if (_has_field_[1]) {
    msg->AppendVarInt(1, ns_);
  }

  // Field 2: valid
  if (_has_field_[2]) {
    msg->AppendVarInt(2, valid_);
  }

  // Field 3: waited
  if (_has_field_[3]) {
    msg->AppendVarInt(3, waited_);
  }
...
void KvmUnmapHvaRangeFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: end
  if (_has_field_[1]) {
    msg->AppendVarInt(1, end_);
  }

  // Field 2: start
  if (_has_field_[2]) {
    msg->AppendVarInt(2, start_);
  }
...
void KvmTimerSaveStateFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: ctl
  if (_has_field_[1]) {
    msg->AppendVarInt(1, ctl_);
  }

  // Field 2: cval
  if (_has_field_[2]) {
    msg->AppendVarInt(2, cval_);
  }

  // Field 3: timer_idx
  if (_has_field_[3]) {
    msg->AppendVarInt(3, timer_idx_);
  }
...
bool KvmTimerEmulateFtraceEvent::operator==(const KvmTimerEmulateFtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   && should_fire_ == other.should_fire_
   && timer_idx_ == other.timer_idx_;
}
...
void KvmTimerEmulateFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: should_fire
  if (_has_field_[1]) {
    msg->AppendVarInt(1, should_fire_);
  }

  // Field 2: timer_idx
  if (_has_field_[2]) {
    msg->AppendVarInt(2, timer_idx_);
  }
...
void KvmSysAccessFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: crm
  if (_has_field_[1]) {
    msg->AppendVarInt(1, crm_);
  }

  // Field 2: crn
  if (_has_field_[2]) {
    msg->AppendVarInt(2, crn_);
  }

  // Field 3: op0
  if (_has_field_[3]) {
    msg->AppendVarInt(3, op0_);
  }

  // Field 4: op1
  if (_has_field_[4]) {
    msg->AppendVarInt(4, op1_);
  }

  // Field 5: op2
  if (_has_field_[5]) {
    msg->AppendVarInt(5, op2_);
  }

  // Field 6: is_write
  if (_has_field_[6]) {
    msg->AppendVarInt(6, is_write_);
  }

  // Field 7: name
  if (_has_field_[7]) {
    msg->AppendString(7, name_);
  }

  // Field 8: vcpu_pc
  if (_has_field_[8]) {
    msg->AppendVarInt(8, vcpu_pc_);
  }
...
bool KvmSetIrqFtraceEvent::operator==(const KvmSetIrqFtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   && gsi_ == other.gsi_
   && irq_source_id_ == other.irq_source_id_
   && level_ == other.level_;
}
...
void KvmSetIrqFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: gsi
  if (_has_field_[1]) {
    msg->AppendVarInt(1, gsi_);
  }

  // Field 2: irq_source_id
  if (_has_field_[2]) {
    msg->AppendVarInt(2, irq_source_id_);
  }

  // Field 3: level
  if (_has_field_[3]) {
    msg->AppendVarInt(3, level_);
  }
...
bool KvmSetGuestDebugFtraceEvent::operator==(const KvmSetGuestDebugFtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   && guest_debug_ == other.guest_debug_
   && vcpu_ == other.vcpu_;
}
...
void KvmSetGuestDebugFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: guest_debug
  if (_has_field_[1]) {
    msg->AppendVarInt(1, guest_debug_);
  }

  // Field 2: vcpu
  if (_has_field_[2]) {
    msg->AppendVarInt(2, vcpu_);
  }
...
void KvmMmioEmulateFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: cpsr
  if (_has_field_[1]) {
    msg->AppendVarInt(1, cpsr_);
  }

  // Field 2: instr
  if (_has_field_[2]) {
    msg->AppendVarInt(2, instr_);
  }

  // Field 3: vcpu_pc
  if (_has_field_[3]) {
    msg->AppendVarInt(3, vcpu_pc_);
  }
...
bool KvmIrqLineFtraceEvent::operator==(const KvmIrqLineFtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   && irq_num_ == other.irq_num_
   && level_ == other.level_
   && type_ == other.type_
   && vcpu_idx_ == other.vcpu_idx_;
}
...
void KvmHvcArm64FtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: imm
  if (_has_field_[1]) {
    msg->AppendVarInt(1, imm_);
  }

  // Field 2: r0
  if (_has_field_[2]) {
    msg->AppendVarInt(2, r0_);
  }
...
void KvmGuestFaultFtraceEvent::Serialize(::protozero::Message* msg) const {
  ...
  // Field 2: hxfar
  if (_has_field_[2]) {
    msg->AppendVarInt(2, hxfar_);
  }

  // Field 3: ipa
  if (_has_field_[3]) {
    msg->AppendVarInt(3, ipa_);
  }

  // Field 4: vcpu_pc
  if (_has_field_[4]) {
    msg->AppendVarInt(4, vcpu_pc_);
  }
...
bool KvmGetTimerMapFtraceEvent::operator==(const KvmGetTimerMapFtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   && direct_ptimer_ == other.direct_ptimer_
   && direct_vtimer_ == other.direct_vtimer_
   && emul_ptimer_ == other.emul_ptimer_
   && vcpu_id_ == other.vcpu_id_;
}
...
void KvmGetTimerMapFtraceEvent::Serialize(::protozero::Message* msg) const {
  ...
  if (_has_field_[1]) {
    msg->AppendVarInt(1, direct_ptimer_);
  }

  // Field 2: direct_vtimer
  if (_has_field_[2]) {
    msg->AppendVarInt(2, direct_vtimer_);
  }

  // Field 3: emul_ptimer
  if (_has_field_[3]) {
    msg->AppendVarInt(3, emul_ptimer_);
  }

  // Field 4: vcpu_id
  if (_has_field_[4]) {
    msg->AppendVarInt(4, vcpu_id_);
  }
...
void KvmAgePageFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: gfn
  if (_has_field_[1]) {
    msg->AppendVarInt(1, gfn_);
  }

  // Field 2: hva
  if (_has_field_[2]) {
    msg->AppendVarInt(2, hva_);
  }
  ...
  // Field 4: referenced
  if (_has_field_[4]) {
    msg->AppendVarInt(4, referenced_);
  }
...
void KvmAckIrqFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: irqchip
  if (_has_field_[1]) {
    msg->AppendVarInt(1, irqchip_);
  }

  // Field 2: pin
  if (_has_field_[2]) {
    msg->AppendVarInt(2, pin_);
  }
