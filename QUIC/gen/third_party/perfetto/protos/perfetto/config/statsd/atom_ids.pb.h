...
#ifndef GOOGLE_PROTOBUF_INCLUDED_protos_2fperfetto_2fconfig_2fstatsd_2fatom_5fids_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_protos_2fperfetto_2fconfig_2fstatsd_2fatom_5fids_2eproto
...
constexpr AtomId AtomId_MIN = BLE_SCAN_STATE_CHANGED;
constexpr AtomId AtomId_MAX = REMOTE_KEY_PROVISIONING_ERROR_COUNTS;
constexpr int AtomId_ARRAYSIZE = AtomId_MAX + 1;

const std::string& AtomId_Name(AtomId value);
template<typename T>
inline const std::string& AtomId_Name(T enum_t_value) {
  static_assert(::std::is_same<T, AtomId>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function AtomId_Name.");
  return AtomId_Name(static_cast<AtomId>(enum_t_value));
}
bool AtomId_Parse(
...
template <> struct is_proto_enum< ::perfetto::protos::AtomId> : ::std::true_type {};
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_protos_2fperfetto_2fconfig_2fstatsd_2fatom_5fids_2eproto
