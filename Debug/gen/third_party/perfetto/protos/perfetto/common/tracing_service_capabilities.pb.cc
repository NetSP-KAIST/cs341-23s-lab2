...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT_WITH_PTR PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TracingServiceCapabilitiesDefaultTypeInternal _TracingServiceCapabilities_default_instance_;
}  // namespace protos
}  // namespace perfetto
namespace perfetto {
namespace protos {
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    reinterpret_cast<char*>(&has_query_capabilities_) - reinterpret_cast<char*>(this)),
    0, static_cast<size_t>(reinterpret_cast<char*>(&has_trace_config_output_path_) -
    reinterpret_cast<char*>(&has_query_capabilities_)) + sizeof(has_trace_config_output_path_));
}
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 8)) {
          ...
          has_query_capabilities_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 24)) {
          ...
          has_trace_config_output_path_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
void TracingServiceCapabilities::InternalSwap(TracingServiceCapabilities* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TracingServiceCapabilities, has_trace_config_output_path_)
      + sizeof(TracingServiceCapabilities::has_trace_config_output_path_)
      - PROTOBUF_FIELD_OFFSET(TracingServiceCapabilities, has_query_capabilities_)>(
          reinterpret_cast<char*>(&has_query_capabilities_),
          reinterpret_cast<char*>(&other->has_query_capabilities_));
}
