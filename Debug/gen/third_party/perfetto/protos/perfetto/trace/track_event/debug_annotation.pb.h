...
inline void DebugAnnotation::clear_name_iid() {
  if (_internal_has_name_iid()) {
    name_field_.name_iid_ = uint64_t{0u};
...
inline void DebugAnnotation::clear_uint_value() {
  if (_internal_has_uint_value()) {
    value_.uint_value_ = uint64_t{0u};
    clear_has_value();
  }
}
...
inline void DebugAnnotation::clear_pointer_value() {
  if (_internal_has_pointer_value()) {
    value_.pointer_value_ = uint64_t{0u};
    clear_has_value();
  }
}
...
inline ::perfetto::protos::DebugAnnotation_NestedValue* DebugAnnotation::_internal_mutable_nested_value() {
  if (!_internal_has_nested_value()) {
    clear_value();
    set_has_nested_value();
    value_.nested_value_ = CreateMaybeMessage< ::perfetto::protos::DebugAnnotation_NestedValue >(GetArenaForAllocation());
  }
...
inline void DebugAnnotation::set_legacy_json_value(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_legacy_json_value()) {
    ...
    value_.legacy_json_value_.InitDefault();
  }
  value_.legacy_json_value_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void DebugAnnotation::_internal_set_legacy_json_value(const std::string& value) {
  ...
  value_.legacy_json_value_.Set(value, GetArenaForAllocation());
}
inline std::string* DebugAnnotation::_internal_mutable_legacy_json_value() {
  ...
  return value_.legacy_json_value_.Mutable(      GetArenaForAllocation());
}
inline std::string* DebugAnnotation::release_legacy_json_value() {
  ...
  if (_internal_has_legacy_json_value()) {
    clear_has_value();
    return value_.legacy_json_value_.Release();
  } else {
    return nullptr;
  }
}
...
inline void DebugAnnotation::set_proto_type_name(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_proto_type_name()) {
    ...
    proto_type_descriptor_.proto_type_name_.InitDefault();
  }
  proto_type_descriptor_.proto_type_name_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void DebugAnnotation::_internal_set_proto_type_name(const std::string& value) {
  ...
  proto_type_descriptor_.proto_type_name_.Set(value, GetArenaForAllocation());
}
inline std::string* DebugAnnotation::_internal_mutable_proto_type_name() {
  ...
  return proto_type_descriptor_.proto_type_name_.Mutable(      GetArenaForAllocation());
}
inline std::string* DebugAnnotation::release_proto_type_name() {
  ...
  if (_internal_has_proto_type_name()) {
    clear_has_proto_type_descriptor();
    return proto_type_descriptor_.proto_type_name_.Release();
  } else {
    return nullptr;
  }
}
inline void DebugAnnotation::set_allocated_proto_type_name(std::string* proto_type_name) {
  ...
  if (proto_type_name != nullptr) {
    set_has_proto_type_name();
    proto_type_descriptor_.proto_type_name_.InitAllocated(proto_type_name, GetArenaForAllocation());
  }
...
inline void DebugAnnotation::clear_proto_type_name_iid() {
  if (_internal_has_proto_type_name_iid()) {
    proto_type_descriptor_.proto_type_name_iid_ = uint64_t{0u};
    clear_has_proto_type_descriptor();
  }
}
...
void DebugAnnotation::set_proto_value(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 proto_value_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void DebugAnnotation::_internal_set_proto_value(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  proto_value_.Set(value, GetArenaForAllocation());
}
inline std::string* DebugAnnotation::_internal_mutable_proto_value() {
  _has_bits_[0] |= 0x00000001u;
  return proto_value_.Mutable(GetArenaForAllocation());
}
inline std::string* DebugAnnotation::release_proto_value() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = proto_value_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (proto_value_.IsDefault()) {
...
inline void DebugAnnotation::set_allocated_proto_value(std::string* proto_value) {
  ...
  proto_value_.SetAllocated(proto_value, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (proto_value_.IsDefault()) {
    proto_value_.Set("", GetArenaForAllocation());
  }
