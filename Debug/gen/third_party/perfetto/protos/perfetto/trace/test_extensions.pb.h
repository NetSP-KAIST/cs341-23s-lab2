...
inline void TestExtensionChild::clear_child_field_for_testing() {
  child_field_for_testing_.ClearToEmpty();
...
void TestExtensionChild::set_child_field_for_testing(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 child_field_for_testing_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline std::string* TestExtensionChild::release_child_field_for_testing() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  auto* p = child_field_for_testing_.Release();
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (child_field_for_testing_.IsDefault()) {
...
inline void TestExtensionChild::set_allocated_child_field_for_testing(std::string* child_field_for_testing) {
  ...
  child_field_for_testing_.SetAllocated(child_field_for_testing, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (child_field_for_testing_.IsDefault()) {
    child_field_for_testing_.Set("", GetArenaForAllocation());
  }
