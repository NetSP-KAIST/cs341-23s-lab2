...
class FrameTimelineEvent_ExpectedSurfaceFrameStart final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(FrameTimelineEvent_ExpectedSurfaceFrameStart* other) {
  ...
  private:
  bool _internal_has_display_frame_token() const;
  public:
...
class FrameTimelineEvent_ActualSurfaceFrameStart final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(FrameTimelineEvent_ActualSurfaceFrameStart* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  private:
  bool _internal_has_present_type() const;
  public:
  ...
  private:
  bool _internal_has_on_time_finish() const;
  public:
  ...
  private:
  bool _internal_has_gpu_composition() const;
  public:
  ...
  private:
  bool _internal_has_jank_type() const;
  public:
  ...
  private:
  bool _internal_has_prediction_type() const;
  public:
...
class FrameTimelineEvent_ExpectedDisplayFrameStart final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(FrameTimelineEvent_ExpectedDisplayFrameStart* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
class FrameTimelineEvent_ActualDisplayFrameStart final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(FrameTimelineEvent_ActualDisplayFrameStart* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
class FrameTimelineEvent_FrameEnd final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(FrameTimelineEvent_FrameEnd* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
...
class FrameTimelineEvent final :
 ...
 public:
  ...
  PROTOBUF_NOINLINE void Swap(FrameTimelineEvent* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  static inline bool PresentType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      PresentType* value) {
  ...
  static inline bool PredictionType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
...
inline bool FrameTimelineEvent_ExpectedSurfaceFrameStart::has_display_frame_token() const {
  return _internal_has_display_frame_token();
}
...
inline bool FrameTimelineEvent_ActualSurfaceFrameStart::has_present_type() const {
  return _internal_has_present_type();
}
...
inline bool FrameTimelineEvent_ActualSurfaceFrameStart::has_on_time_finish() const {
  return _internal_has_on_time_finish();
}
...
inline bool FrameTimelineEvent_ActualSurfaceFrameStart::has_gpu_composition() const {
  return _internal_has_gpu_composition();
}
...
inline bool FrameTimelineEvent_ActualSurfaceFrameStart::has_jank_type() const {
  return _internal_has_jank_type();
}
...
inline bool FrameTimelineEvent_ActualSurfaceFrameStart::has_prediction_type() const {
  return _internal_has_prediction_type();
}
...
inline bool FrameTimelineEvent::has_expected_display_frame_start() const {
  return _internal_has_expected_display_frame_start();
}
...
inline void FrameTimelineEvent::clear_expected_display_frame_start() {
  if (_internal_has_expected_display_frame_start()) {
...
inline ::perfetto::protos::FrameTimelineEvent_ExpectedDisplayFrameStart* FrameTimelineEvent::_internal_mutable_expected_display_frame_start() {
  if (!_internal_has_expected_display_frame_start()) {
    clear_event();
    set_has_expected_display_frame_start();
    event_.expected_display_frame_start_ = CreateMaybeMessage< ::perfetto::protos::FrameTimelineEvent_ExpectedDisplayFrameStart >(GetArenaForAllocation());
  }
...
inline bool FrameTimelineEvent::has_actual_display_frame_start() const {
  return _internal_has_actual_display_frame_start();
}
...
inline void FrameTimelineEvent::clear_actual_display_frame_start() {
  if (_internal_has_actual_display_frame_start()) {
    if (GetArenaForAllocation() == nullptr) {
...
inline ::perfetto::protos::FrameTimelineEvent_ActualDisplayFrameStart* FrameTimelineEvent::_internal_mutable_actual_display_frame_start() {
  if (!_internal_has_actual_display_frame_start()) {
    clear_event();
    set_has_actual_display_frame_start();
    event_.actual_display_frame_start_ = CreateMaybeMessage< ::perfetto::protos::FrameTimelineEvent_ActualDisplayFrameStart >(GetArenaForAllocation());
  }
...
inline bool FrameTimelineEvent::has_expected_surface_frame_start() const {
  return _internal_has_expected_surface_frame_start();
}
...
inline void FrameTimelineEvent::clear_expected_surface_frame_start() {
  if (_internal_has_expected_surface_frame_start()) {
    if (GetArenaForAllocation() == nullptr) {
...
inline ::perfetto::protos::FrameTimelineEvent_ExpectedSurfaceFrameStart* FrameTimelineEvent::_internal_mutable_expected_surface_frame_start() {
  if (!_internal_has_expected_surface_frame_start()) {
    clear_event();
    set_has_expected_surface_frame_start();
    event_.expected_surface_frame_start_ = CreateMaybeMessage< ::perfetto::protos::FrameTimelineEvent_ExpectedSurfaceFrameStart >(GetArenaForAllocation());
  }
...
inline bool FrameTimelineEvent::has_actual_surface_frame_start() const {
  return _internal_has_actual_surface_frame_start();
}
...
inline void FrameTimelineEvent::clear_actual_surface_frame_start() {
  if (_internal_has_actual_surface_frame_start()) {
    if (GetArenaForAllocation() == nullptr) {
...
inline ::perfetto::protos::FrameTimelineEvent_ActualSurfaceFrameStart* FrameTimelineEvent::_internal_mutable_actual_surface_frame_start() {
  if (!_internal_has_actual_surface_frame_start()) {
    clear_event();
    set_has_actual_surface_frame_start();
    event_.actual_surface_frame_start_ = CreateMaybeMessage< ::perfetto::protos::FrameTimelineEvent_ActualSurfaceFrameStart >(GetArenaForAllocation());
  }
...
inline ::perfetto::protos::FrameTimelineEvent_FrameEnd* FrameTimelineEvent::_internal_mutable_frame_end() {
  if (!_internal_has_frame_end()) {
    clear_event();
    set_has_frame_end();
    event_.frame_end_ = CreateMaybeMessage< ::perfetto::protos::FrameTimelineEvent_FrameEnd >(GetArenaForAllocation());
  }
