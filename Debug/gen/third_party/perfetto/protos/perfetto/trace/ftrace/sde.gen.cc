...
void SdeSdePerfUpdateBusFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: ab_quota
  if (_has_field_[1]) {
    msg->AppendVarInt(1, ab_quota_);
  }

  // Field 2: bus_id
  if (_has_field_[2]) {
    msg->AppendVarInt(2, bus_id_);
  }

  // Field 3: client
  if (_has_field_[3]) {
    msg->AppendVarInt(3, client_);
  }

  // Field 4: ib_quota
  if (_has_field_[4]) {
    msg->AppendVarInt(4, ib_quota_);
  }
...
void SdeSdePerfSetQosLutsFtraceEvent::Serialize(::protozero::Message* msg) const {
  ...
  // Field 3: lut
  if (_has_field_[3]) {
    msg->AppendVarInt(3, lut_);
  }

  // Field 4: lut_usage
  if (_has_field_[4]) {
    msg->AppendVarInt(4, lut_usage_);
  }

  // Field 5: pnum
  if (_has_field_[5]) {
    msg->AppendVarInt(5, pnum_);
  }

  // Field 6: rt
  if (_has_field_[6]) {
    msg->AppendVarInt(6, rt_);
  }
...
bool SdeSdePerfCrtcUpdateFtraceEvent::operator==(const SdeSdePerfCrtcUpdateFtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   && bw_ctl_ebi_ == other.bw_ctl_ebi_
   && bw_ctl_llcc_ == other.bw_ctl_llcc_
   && bw_ctl_mnoc_ == other.bw_ctl_mnoc_
   && core_clk_rate_ == other.core_clk_rate_
   && crtc_ == other.crtc_
   && params_ == other.params_
   && per_pipe_ib_ebi_ == other.per_pipe_ib_ebi_
   && per_pipe_ib_llcc_ == other.per_pipe_ib_llcc_
   && per_pipe_ib_mnoc_ == other.per_pipe_ib_mnoc_
   && stop_req_ == other.stop_req_
   && update_bus_ == other.update_bus_
   && update_clk_ == other.update_clk_;
}
...
void SdeSdePerfCrtcUpdateFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: bw_ctl_ebi
  if (_has_field_[1]) {
    msg->AppendVarInt(1, bw_ctl_ebi_);
  }

  // Field 2: bw_ctl_llcc
  if (_has_field_[2]) {
    msg->AppendVarInt(2, bw_ctl_llcc_);
  }

  // Field 3: bw_ctl_mnoc
  if (_has_field_[3]) {
    msg->AppendVarInt(3, bw_ctl_mnoc_);
  }

  // Field 4: core_clk_rate
  if (_has_field_[4]) {
    msg->AppendVarInt(4, core_clk_rate_);
  }

  // Field 5: crtc
  if (_has_field_[5]) {
    msg->AppendVarInt(5, crtc_);
  }

  // Field 6: params
  if (_has_field_[6]) {
    msg->AppendVarInt(6, params_);
  }

  // Field 7: per_pipe_ib_ebi
  if (_has_field_[7]) {
    msg->AppendVarInt(7, per_pipe_ib_ebi_);
  }

  // Field 8: per_pipe_ib_llcc
  if (_has_field_[8]) {
    msg->AppendVarInt(8, per_pipe_ib_llcc_);
  }

  // Field 9: per_pipe_ib_mnoc
  if (_has_field_[9]) {
    msg->AppendVarInt(9, per_pipe_ib_mnoc_);
  }

  // Field 10: stop_req
  if (_has_field_[10]) {
    msg->AppendVarInt(10, stop_req_);
  }

  // Field 11: update_bus
  if (_has_field_[11]) {
    msg->AppendVarInt(11, update_bus_);
  }

  // Field 12: update_clk
  if (_has_field_[12]) {
    msg->AppendVarInt(12, update_clk_);
  }
...
bool SdeSdePerfCalcCrtcFtraceEvent::operator==(const SdeSdePerfCalcCrtcFtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   ...
   && core_clk_rate_ == other.core_clk_rate_
   && crtc_ == other.crtc_
   && ib_ebi_ == other.ib_ebi_
   && ib_llcc_ == other.ib_llcc_
   && ib_mnoc_ == other.ib_mnoc_;
}
...
void SdeSdePerfCalcCrtcFtraceEvent::Serialize(::protozero::Message* msg) const {
  ...
  // Field 6: ib_ebi
  if (_has_field_[6]) {
    msg->AppendVarInt(6, ib_ebi_);
  }

  // Field 7: ib_llcc
  if (_has_field_[7]) {
    msg->AppendVarInt(7, ib_llcc_);
  }

  // Field 8: ib_mnoc
  if (_has_field_[8]) {
    msg->AppendVarInt(8, ib_mnoc_);
  }
...
void SdeSdeEvtlogFtraceEvent::Serialize(::protozero::Message* msg) const {
  // Field 1: evtlog_tag
  if (_has_field_[1]) {
    msg->AppendString(1, evtlog_tag_);
  }
