...
bool FtraceEvent::operator==(const FtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   ...
   && dma_heap_stat_ == other.dma_heap_stat_
   && cpuhp_pause_ == other.cpuhp_pause_
   && sched_pi_setprio_ == other.sched_pi_setprio_
   && sde_sde_evtlog_ == other.sde_sde_evtlog_
   && sde_sde_perf_calc_crtc_ == other.sde_sde_perf_calc_crtc_
   && sde_sde_perf_crtc_update_ == other.sde_sde_perf_crtc_update_
   && sde_sde_perf_set_qos_luts_ == other.sde_sde_perf_set_qos_luts_
   && sde_sde_perf_update_bus_ == other.sde_sde_perf_update_bus_
   && rss_stat_throttled_ == other.rss_stat_throttled_
   && netif_receive_skb_ == other.netif_receive_skb_
   && net_dev_xmit_ == other.net_dev_xmit_
   && inet_sock_set_state_ == other.inet_sock_set_state_
   && tcp_retransmit_skb_ == other.tcp_retransmit_skb_
   && cros_ec_sensorhub_data_ == other.cros_ec_sensorhub_data_
   && napi_gro_receive_entry_ == other.napi_gro_receive_entry_
   && napi_gro_receive_exit_ == other.napi_gro_receive_exit_
   && kfree_skb_ == other.kfree_skb_
   && kvm_access_fault_ == other.kvm_access_fault_
   && kvm_ack_irq_ == other.kvm_ack_irq_
   && kvm_age_hva_ == other.kvm_age_hva_
   && kvm_age_page_ == other.kvm_age_page_
   && kvm_arm_clear_debug_ == other.kvm_arm_clear_debug_
   && kvm_arm_set_dreg32_ == other.kvm_arm_set_dreg32_
   && kvm_arm_set_regset_ == other.kvm_arm_set_regset_
   && kvm_arm_setup_debug_ == other.kvm_arm_setup_debug_
   && kvm_entry_ == other.kvm_entry_
   && kvm_exit_ == other.kvm_exit_
   && kvm_fpu_ == other.kvm_fpu_
   && kvm_get_timer_map_ == other.kvm_get_timer_map_
   && kvm_guest_fault_ == other.kvm_guest_fault_
   && kvm_handle_sys_reg_ == other.kvm_handle_sys_reg_
   && kvm_hvc_arm64_ == other.kvm_hvc_arm64_
   && kvm_irq_line_ == other.kvm_irq_line_
   && kvm_mmio_ == other.kvm_mmio_
   && kvm_mmio_emulate_ == other.kvm_mmio_emulate_
   && kvm_set_guest_debug_ == other.kvm_set_guest_debug_
   && kvm_set_irq_ == other.kvm_set_irq_
   && kvm_set_spte_hva_ == other.kvm_set_spte_hva_
   && kvm_set_way_flush_ == other.kvm_set_way_flush_
   && kvm_sys_access_ == other.kvm_sys_access_
   && kvm_test_age_hva_ == other.kvm_test_age_hva_
   && kvm_timer_emulate_ == other.kvm_timer_emulate_
   && kvm_timer_hrtimer_expire_ == other.kvm_timer_hrtimer_expire_
   && kvm_timer_restore_state_ == other.kvm_timer_restore_state_
   && kvm_timer_save_state_ == other.kvm_timer_save_state_
   && kvm_timer_update_irq_ == other.kvm_timer_update_irq_
   && kvm_toggle_cache_ == other.kvm_toggle_cache_
   && kvm_unmap_hva_range_ == other.kvm_unmap_hva_range_
   && kvm_userspace_exit_ == other.kvm_userspace_exit_
   && kvm_vcpu_wakeup_ == other.kvm_vcpu_wakeup_
   && kvm_wfx_arm64_ == other.kvm_wfx_arm64_
   && trap_reg_ == other.trap_reg_
   && vgic_update_irq_pending_ == other.vgic_update_irq_pending_
   && wakeup_source_activate_ == other.wakeup_source_activate_
   && wakeup_source_deactivate_ == other.wakeup_source_deactivate_
   && ufshcd_command_ == other.ufshcd_command_
   && ufshcd_clk_gating_ == other.ufshcd_clk_gating_
   && console_ == other.console_
   && drm_vblank_event_ == other.drm_vblank_event_
   && drm_vblank_event_delivered_ == other.drm_vblank_event_delivered_
   && drm_sched_job_ == other.drm_sched_job_
   && drm_run_job_ == other.drm_run_job_
   && drm_sched_process_job_ == other.drm_sched_process_job_
   && dma_fence_init_ == other.dma_fence_init_
   && dma_fence_emit_ == other.dma_fence_emit_
   && dma_fence_signaled_ == other.dma_fence_signaled_
   && dma_fence_wait_start_ == other.dma_fence_wait_start_
   && dma_fence_wait_end_ == other.dma_fence_wait_end_
   && f2fs_iostat_ == other.f2fs_iostat_
   && f2fs_iostat_latency_ == other.f2fs_iostat_latency_
   && sched_cpu_util_cfs_ == other.sched_cpu_util_cfs_
   && v4l2_qbuf_ == other.v4l2_qbuf_
   && v4l2_dqbuf_ == other.v4l2_dqbuf_
   && vb2_v4l2_buf_queue_ == other.vb2_v4l2_buf_queue_
   && vb2_v4l2_buf_done_ == other.vb2_v4l2_buf_done_
   && vb2_v4l2_qbuf_ == other.vb2_v4l2_qbuf_
   && vb2_v4l2_dqbuf_ == other.vb2_v4l2_dqbuf_
   && dsi_cmd_fifo_status_ == other.dsi_cmd_fifo_status_
   && dsi_rx_ == other.dsi_rx_
   && dsi_tx_ == other.dsi_tx_
   && android_fs_dataread_end_ == other.android_fs_dataread_end_
   && android_fs_dataread_start_ == other.android_fs_dataread_start_
   && android_fs_datawrite_end_ == other.android_fs_datawrite_end_
   && android_fs_datawrite_start_ == other.android_fs_datawrite_start_
   && android_fs_fsync_end_ == other.android_fs_fsync_end_
   && android_fs_fsync_start_ == other.android_fs_fsync_start_
   && funcgraph_entry_ == other.funcgraph_entry_
   && funcgraph_exit_ == other.funcgraph_exit_
   && virtio_video_cmd_ == other.virtio_video_cmd_
   && virtio_video_cmd_done_ == other.virtio_video_cmd_done_
   && virtio_video_resource_queue_ == other.virtio_video_resource_queue_
   && virtio_video_resource_queue_done_ == other.virtio_video_resource_queue_done_
   && mm_shrink_slab_start_ == other.mm_shrink_slab_start_
   && mm_shrink_slab_end_ == other.mm_shrink_slab_end_
   && trusty_smc_ == other.trusty_smc_
   && trusty_smc_done_ == other.trusty_smc_done_
   && trusty_std_call32_ == other.trusty_std_call32_
   && trusty_std_call32_done_ == other.trusty_std_call32_done_
   && trusty_share_memory_ == other.trusty_share_memory_
   && trusty_share_memory_done_ == other.trusty_share_memory_done_
   && trusty_reclaim_memory_ == other.trusty_reclaim_memory_
   && trusty_reclaim_memory_done_ == other.trusty_reclaim_memory_done_
   && trusty_irq_ == other.trusty_irq_
   && trusty_ipc_handle_event_ == other.trusty_ipc_handle_event_
   && trusty_ipc_connect_ == other.trusty_ipc_connect_
   && trusty_ipc_connect_end_ == other.trusty_ipc_connect_end_
   && trusty_ipc_write_ == other.trusty_ipc_write_
   && trusty_ipc_poll_ == other.trusty_ipc_poll_
   && trusty_ipc_read_ == other.trusty_ipc_read_
   && trusty_ipc_read_end_ == other.trusty_ipc_read_end_
   && trusty_ipc_rx_ == other.trusty_ipc_rx_
   && trusty_enqueue_nop_ == other.trusty_enqueue_nop_
   && cma_alloc_start_ == other.cma_alloc_start_
   && cma_alloc_info_ == other.cma_alloc_info_
   && lwis_tracing_mark_write_ == other.lwis_tracing_mark_write_
   && virtio_gpu_cmd_queue_ == other.virtio_gpu_cmd_queue_
   && virtio_gpu_cmd_response_ == other.virtio_gpu_cmd_response_
   && mali_mali_kcpu_cqs_set_ == other.mali_mali_kcpu_cqs_set_
   && mali_mali_kcpu_cqs_wait_start_ == other.mali_mali_kcpu_cqs_wait_start_
