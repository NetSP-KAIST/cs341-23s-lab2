...
void CgroupRenameFtraceEvent::Serialize(::protozero::Message* msg) const {
  ...
  // Field 4: level
  if (_has_field_[4]) {
    msg->AppendVarInt(4, level_);
  }

  // Field 5: path
  if (_has_field_[5]) {
    msg->AppendString(5, path_);
  }
...
bool CgroupTransferTasksFtraceEvent::operator==(const CgroupTransferTasksFtraceEvent& other) const {
  return unknown_fields_ == other.unknown_fields_
   ...
   && comm_ == other.comm_
   && cname_ == other.cname_
   && dst_level_ == other.dst_level_
   && dst_path_ == other.dst_path_;
}
...
void CgroupTransferTasksFtraceEvent::Serialize(::protozero::Message* msg) const {
  ...
  // Field 6: dst_level
  if (_has_field_[6]) {
    msg->AppendVarInt(6, dst_level_);
  }

  // Field 7: dst_path
  if (_has_field_[7]) {
    msg->AppendString(7, dst_path_);
  }
