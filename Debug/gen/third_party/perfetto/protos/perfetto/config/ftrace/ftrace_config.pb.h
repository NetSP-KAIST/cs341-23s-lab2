...
inline void FtraceConfig_PrintFilter_Rule::set_prefix(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_prefix()) {
    clear_match();
    set_has_prefix();
    match_.prefix_.InitDefault();
  }
  match_.prefix_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void FtraceConfig_PrintFilter_Rule::_internal_set_prefix(const std::string& value) {
  ...
  match_.prefix_.Set(value, GetArenaForAllocation());
}
inline std::string* FtraceConfig_PrintFilter_Rule::_internal_mutable_prefix() {
  ...
  return match_.prefix_.Mutable(      GetArenaForAllocation());
}
...
inline void FtraceConfig_PrintFilter_Rule::set_allocated_prefix(std::string* prefix) {
  ...
  if (prefix != nullptr) {
    set_has_prefix();
    match_.prefix_.InitAllocated(prefix, GetArenaForAllocation());
  }
...
inline ::perfetto::protos::FtraceConfig_PrintFilter_Rule_AtraceMessage* FtraceConfig_PrintFilter_Rule::release_atrace_msg() {
  ...
  if (_internal_has_atrace_msg()) {
    clear_has_match();
    ::perfetto::protos::FtraceConfig_PrintFilter_Rule_AtraceMessage* temp = match_.atrace_msg_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    match_.atrace_msg_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::perfetto::protos::FtraceConfig_PrintFilter_Rule_AtraceMessage* FtraceConfig_PrintFilter_Rule::_internal_mutable_atrace_msg() {
  if (!_internal_has_atrace_msg()) {
    clear_match();
    set_has_atrace_msg();
    match_.atrace_msg_ = CreateMaybeMessage< ::perfetto::protos::FtraceConfig_PrintFilter_Rule_AtraceMessage >(GetArenaForAllocation());
  }
  return match_.atrace_msg_;
}
...
inline FtraceConfig_PrintFilter_Rule::MatchCase FtraceConfig_PrintFilter_Rule::match_case() const {
  return FtraceConfig_PrintFilter_Rule::MatchCase(_oneof_case_[0]);
}
// -------------------------------------------------------------------
...
inline bool FtraceConfig::_internal_has_print_filter() const {
  bool value = (_has_bits_[0] & 0x00000002u) != 0;
  PROTOBUF_ASSUME(!value || print_filter_ != nullptr);
  return value;
}
...
inline void FtraceConfig::clear_print_filter() {
  if (print_filter_ != nullptr) print_filter_->Clear();
  _has_bits_[0] &= ~0x00000002u;
}
inline const ::perfetto::protos::FtraceConfig_PrintFilter& FtraceConfig::_internal_print_filter() const {
  const ::perfetto::protos::FtraceConfig_PrintFilter* p = print_filter_;
...
inline void FtraceConfig::unsafe_arena_set_allocated_print_filter(
    ::perfetto::protos::FtraceConfig_PrintFilter* print_filter) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(print_filter_);
  }
  print_filter_ = print_filter;
  if (print_filter) {
    _has_bits_[0] |= 0x00000002u;
  } else {
    _has_bits_[0] &= ~0x00000002u;
...
inline ::perfetto::protos::FtraceConfig_PrintFilter* FtraceConfig::release_print_filter() {
  _has_bits_[0] &= ~0x00000002u;
  ::perfetto::protos::FtraceConfig_PrintFilter* temp = print_filter_;
...
inline ::perfetto::protos::FtraceConfig_KsymsMemPolicy FtraceConfig::_internal_ksyms_mem_policy() const {
  return static_cast< ::perfetto::protos::FtraceConfig_KsymsMemPolicy >(ksyms_mem_policy_);
}
...
inline const std::string& FtraceConfig::_internal_syscall_events(int index) const {
  return syscall_events_.Get(index);
}
...
inline std::string* FtraceConfig::mutable_syscall_events(int index) {
  ...
  return syscall_events_.Mutable(index);
}
inline void FtraceConfig::set_syscall_events(int index, const std::string& value) {
  syscall_events_.Mutable(index)->assign(value);
...
inline void FtraceConfig::set_syscall_events(int index, std::string&& value) {
  syscall_events_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:perfetto.protos.FtraceConfig.syscall_events)
}
...
inline void FtraceConfig::set_syscall_events(int index, const char* value, size_t size) {
  syscall_events_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
...
inline void FtraceConfig::add_syscall_events(std::string&& value) {
  syscall_events_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:perfetto.protos.FtraceConfig.syscall_events)
}
...
inline void FtraceConfig::add_syscall_events(const char* value, size_t size) {
  syscall_events_.Add()->assign(reinterpret_cast<const char*>(value), size);
...
inline const std::string& FtraceConfig::_internal_function_filters(int index) const {
  return function_filters_.Get(index);
}
...
inline std::string* FtraceConfig::mutable_function_filters(int index) {
  ...
  return function_filters_.Mutable(index);
}
inline void FtraceConfig::set_function_filters(int index, const std::string& value) {
  function_filters_.Mutable(index)->assign(value);
...
inline void FtraceConfig::set_function_filters(int index, std::string&& value) {
  function_filters_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:perfetto.protos.FtraceConfig.function_filters)
}
...
inline void FtraceConfig::set_function_filters(int index, const char* value, size_t size) {
  function_filters_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
...
inline void FtraceConfig::add_function_filters(std::string&& value) {
  function_filters_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:perfetto.protos.FtraceConfig.function_filters)
}
...
inline void FtraceConfig::add_function_filters(const char* value, size_t size) {
  function_filters_.Add()->assign(reinterpret_cast<const char*>(value), size);
...
inline int FtraceConfig::_internal_function_graph_roots_size() const {
  return function_graph_roots_.size();
}
...
inline const std::string& FtraceConfig::_internal_function_graph_roots(int index) const {
  return function_graph_roots_.Get(index);
}
...
inline std::string* FtraceConfig::mutable_function_graph_roots(int index) {
  ...
  return function_graph_roots_.Mutable(index);
}
inline void FtraceConfig::set_function_graph_roots(int index, const std::string& value) {
  function_graph_roots_.Mutable(index)->assign(value);
...
inline void FtraceConfig::set_function_graph_roots(int index, std::string&& value) {
  function_graph_roots_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:perfetto.protos.FtraceConfig.function_graph_roots)
}
...
inline void FtraceConfig::set_function_graph_roots(int index, const char* value, size_t size) {
  function_graph_roots_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
...
inline void FtraceConfig::add_function_graph_roots(std::string&& value) {
  function_graph_roots_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:perfetto.protos.FtraceConfig.function_graph_roots)
}
...
inline void FtraceConfig::add_function_graph_roots(const char* value, size_t size) {
  function_graph_roots_.Add()->assign(reinterpret_cast<const char*>(value), size);
...
inline bool FtraceConfig::_internal_preserve_ftrace_buffer() const {
  return preserve_ftrace_buffer_;
}
...
inline bool FtraceConfig::_internal_use_monotonic_raw_clock() const {
  return use_monotonic_raw_clock_;
}
...
inline void FtraceConfig::_internal_set_use_monotonic_raw_clock(bool value) {
  _has_bits_[0] |= 0x00000800u;
  use_monotonic_raw_clock_ = value;
}
