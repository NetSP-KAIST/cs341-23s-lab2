...
TraceConfig_BuiltinDataSource::TraceConfig_BuiltinDataSource(const TraceConfig_BuiltinDataSource& from)
  ...
  ::memcpy(&disable_clock_snapshotting_, &from.disable_clock_snapshotting_,
    static_cast<size_t>(reinterpret_cast<char*>(&prefer_suspend_clock_for_snapshot_) -
    reinterpret_cast<char*>(&disable_clock_snapshotting_)) + sizeof(prefer_suspend_clock_for_snapshot_));
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&prefer_suspend_clock_for_snapshot_) -
    reinterpret_cast<char*>(&disable_clock_snapshotting_)) + sizeof(prefer_suspend_clock_for_snapshot_));
}
...
// @@protoc_insertion_point(message_clear_start:perfetto.protos.TraceConfig.BuiltinDataSource)
  ...
  if (cached_has_bits & 0x0000007fu) {
    ::memset(&disable_clock_snapshotting_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&prefer_suspend_clock_for_snapshot_) -
        reinterpret_cast<char*>(&disable_clock_snapshotting_)) + sizeof(prefer_suspend_clock_for_snapshot_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear<std::string>();
...
void TraceConfig_BuiltinDataSource::InternalSwap(TraceConfig_BuiltinDataSource* other) {
  ...
  swap(_has_bits_[0], other->_has_bits_[0]);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TraceConfig_BuiltinDataSource, prefer_suspend_clock_for_snapshot_)
      + sizeof(TraceConfig_BuiltinDataSource::prefer_suspend_clock_for_snapshot_)
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    0, static_cast<size_t>(reinterpret_cast<char*>(&trigger_timeout_ms_) -
    reinterpret_cast<char*>(&trigger_mode_)) + sizeof(trigger_timeout_ms_));
}
...
void TraceConfig_TriggerConfig::InternalSwap(TraceConfig_TriggerConfig* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TraceConfig_TriggerConfig, trigger_timeout_ms_)
      + sizeof(TraceConfig_TriggerConfig::trigger_timeout_ms_)
